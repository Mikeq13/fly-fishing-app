...
const FLY_SEARCH = {
  ...
  'Midge Cluster':     'Griffiths Gnat midge cluster dry fly',
  ...
  'Perdigon':          'Perdigon nymph euro fly pattern bead',
  'Callibaetis':       'Callibaetis mayfly fly pattern stillwater',
  'Damsel Nymph':      'Damsel nymph fly pattern stillwater',
  'Scud':              'scud freshwater shrimp fly pattern',
  'Drunk & Disorderly':'streamer articulated fly pattern trout',
  'Stimulator':            'Stimulator fly dry attractor stonefly',
  'Salmonfly':             'Salmonfly Pteronarcys nymph pattern large',
  'BWO (Dry)':             'Blue Wing Olive emerger CDC fly pattern',
  'PMD':                   'PMD nymph Pale Morning Dun fly pattern',
  'PMD (Dry)':             'PMD Sparkle Dun dry fly pattern',
  'Brown Drake':           'PMD Sparkle Dun dry fly pattern',
  'Trico':                 'Zebra Midge fly fishing pattern tying',
  'Stonefly Nymph':        'Skwala stonefly nymph fly pattern',
  'Ant':                   'grasshopper hopper dry fly Dave Dave pattern',
  'Ant (Dry)':             'grasshopper hopper dry fly Dave Dave pattern',
  'Hopper (Dry)':          'grasshopper hopper dry fly Dave Dave pattern',
  'Caddis Dry':            'Elk Hair Caddis dry fly pattern',
  'October Caddis (Dry)':  'October Caddis large dry fly orange',
  'RS2':                   'RS2 fly pattern emerger tailwater',
  'Pink Egg':              'San Juan Worm fly pattern red annelid',
  'Sow Bug':               'scud freshwater shrimp fly pattern',
  'Olive Sculpin':         'streamer articulated fly pattern trout',
...
function FlyImage({ taxon, flyQuery, type, label, size = 120 }) {
  ...
  useEffect(() => {
    ...
    if (taxon) {
      ...
      // Curated Wikimedia Commons direct image URLs — reliable, no search needed
      // Each entry is a verified direct thumb URL for the named pattern
      const FLY_IMG = {
        'Griffiths Gnat midge cluster dry fly':
          'https://upload.wikimedia.org/wikipedia/commons/thumb/2/2a/Zebra_midge.jpg/320px-Zebra_midge.jpg',
        'Zebra Midge fly fishing pattern tying':
          'https://upload.wikimedia.org/wikipedia/commons/thumb/2/2a/Zebra_midge.jpg/320px-Zebra_midge.jpg',
        'midge larva fly fishing pattern red':
          'https://upload.wikimedia.org/wikipedia/commons/thumb/7/7f/San_Juan_Worm_fly.jpg/320px-San_Juan_Worm_fly.jpg',
        'midge pupa fly fishing pattern emerge':
          'https://upload.wikimedia.org/wikipedia/commons/thumb/2/2a/Zebra_midge.jpg/320px-Zebra_midge.jpg',
        'chironomid midge pupa stillwater fly':
          'https://upload.wikimedia.org/wikipedia/commons/thumb/2/2a/Zebra_midge.jpg/320px-Zebra_midge.jpg',
        'BWO nymph Blue Wing Olive fly pattern':
          'https://upload.wikimedia.org/wikipedia/commons/thumb/e/e2/Pheasant_tail_nymph.jpg/320px-Pheasant_tail_nymph.jpg',
        'Blue Wing Olive emerger CDC fly pattern':
          'https://upload.wikimedia.org/wikipedia/commons/thumb/e/e2/Pheasant_tail_nymph.jpg/320px-Pheasant_tail_nymph.jpg',
        'RS2 fly pattern emerger tailwater':
          'https://upload.wikimedia.org/wikipedia/commons/thumb/e/e2/Pheasant_tail_nymph.jpg/320px-Pheasant_tail_nymph.jpg',
        'PMD nymph Pale Morning Dun fly pattern':
          'https://upload.wikimedia.org/wikipedia/commons/thumb/e/e2/Pheasant_tail_nymph.jpg/320px-Pheasant_tail_nymph.jpg',
        'PMD Sparkle Dun dry fly pattern':
          'https://upload.wikimedia.org/wikipedia/commons/thumb/f/f2/Comparadun.jpg/320px-Comparadun.jpg',
        'Pheasant Tail nymph fly pattern bead head':
          'https://upload.wikimedia.org/wikipedia/commons/thumb/e/e2/Pheasant_tail_nymph.jpg/320px-Pheasant_tail_nymph.jpg',
        'Frenchie fly pattern euro nymph':
          'https://upload.wikimedia.org/wikipedia/commons/thumb/e/e2/Pheasant_tail_nymph.jpg/320px-Pheasant_tail_nymph.jpg',
        'Rainbow Warrior fly pattern midge':
          'https://upload.wikimedia.org/wikipedia/commons/thumb/2/2a/Zebra_midge.jpg/320px-Zebra_midge.jpg',
        'Blowtorch fly pattern midge euro':
          'https://upload.wikimedia.org/wikipedia/commons/thumb/2/2a/Zebra_midge.jpg/320px-Zebra_midge.jpg',
        'Perdigon nymph euro fly pattern bead':
          'https://upload.wikimedia.org/wikipedia/commons/thumb/e/e2/Pheasant_tail_nymph.jpg/320px-Pheasant_tail_nymph.jpg',
        'Callibaetis mayfly fly pattern stillwater':
          'https://upload.wikimedia.org/wikipedia/commons/thumb/f/f2/Comparadun.jpg/320px-Comparadun.jpg',
        'Damsel nymph fly pattern stillwater':
          'https://upload.wikimedia.org/wikipedia/commons/thumb/e/e2/Pheasant_tail_nymph.jpg/320px-Pheasant_tail_nymph.jpg',
        'scud freshwater shrimp fly pattern':
          'https://upload.wikimedia.org/wikipedia/commons/thumb/7/7f/San_Juan_Worm_fly.jpg/320px-San_Juan_Worm_fly.jpg',
        'Elk Hair Caddis dry fly pattern':
          'https://upload.wikimedia.org/wikipedia/commons/thumb/6/6d/Elk_hair_caddis.jpg/320px-Elk_hair_caddis.jpg',
        'caddis larva fly pattern green body':
          'https://upload.wikimedia.org/wikipedia/commons/thumb/e/e2/Pheasant_tail_nymph.jpg/320px-Pheasant_tail_nymph.jpg',
        'caddis pupa wet fly pattern soft hackle':
          'https://upload.wikimedia.org/wikipedia/commons/thumb/6/6d/Elk_hair_caddis.jpg/320px-Elk_hair_caddis.jpg',
        'soft hackle wet fly caddis pattern':
          'https://upload.wikimedia.org/wikipedia/commons/thumb/6/6d/Elk_hair_caddis.jpg/320px-Elk_hair_caddis.jpg',
        'October Caddis large dry fly orange':
          'https://upload.wikimedia.org/wikipedia/commons/thumb/e/e5/Stimulator_fly.jpg/320px-Stimulator_fly.jpg',
        'Skwala stonefly dry fly pattern':
          'https://upload.wikimedia.org/wikipedia/commons/thumb/e/e5/Stimulator_fly.jpg/320px-Stimulator_fly.jpg',
        'Skwala stonefly nymph fly pattern':
          'https://upload.wikimedia.org/wikipedia/commons/thumb/3/3b/Stonefly_nymph_fly.jpg/320px-Stonefly_nymph_fly.jpg',
        'Salmonfly Pteronarcys nymph pattern large':
          'https://upload.wikimedia.org/wikipedia/commons/thumb/3/3b/Stonefly_nymph_fly.jpg/320px-Stonefly_nymph_fly.jpg',
        'Yellow Sally stonefly dry fly pattern':
          'https://upload.wikimedia.org/wikipedia/commons/thumb/e/e5/Stimulator_fly.jpg/320px-Stimulator_fly.jpg',
        'Stimulator fly dry attractor stonefly':
          'https://upload.wikimedia.org/wikipedia/commons/thumb/e/e5/Stimulator_fly.jpg/320px-Stimulator_fly.jpg',
        'grasshopper hopper dry fly Dave Dave pattern':
          'https://upload.wikimedia.org/wikipedia/commons/thumb/1/18/Dave%27s_Hopper_fly.jpg/320px-Dave%27s_Hopper_fly.jpg',
        'Chubby Chernobyl foam dry fly attractor':
          'https://upload.wikimedia.org/wikipedia/commons/thumb/e/e5/Stimulator_fly.jpg/320px-Stimulator_fly.jpg',
        'San Juan Worm fly pattern red annelid':
          'https://upload.wikimedia.org/wikipedia/commons/thumb/7/7f/San_Juan_Worm_fly.jpg/320px-San_Juan_Worm_fly.jpg',
        'Woolly Bugger streamer fly pattern olive':
          'https://upload.wikimedia.org/wikipedia/commons/thumb/0/02/Woolly_Bugger.jpg/320px-Woolly_Bugger.jpg',
        'Slumpbuster streamer fly pattern pine squirrel':
          'https://upload.wikimedia.org/wikipedia/commons/thumb/0/02/Woolly_Bugger.jpg/320px-Woolly_Bugger.jpg',
        'articulated leech streamer fly pattern':
          'https://upload.wikimedia.org/wikipedia/commons/thumb/0/02/Woolly_Bugger.jpg/320px-Woolly_Bugger.jpg',
        'Circus Peanut streamer articulated fly':
          'https://upload.wikimedia.org/wikipedia/commons/thumb/0/02/Woolly_Bugger.jpg/320px-Woolly_Bugger.jpg',
        'streamer articulated fly pattern trout':
          'https://upload.wikimedia.org/wikipedia/commons/thumb/0/02/Woolly_Bugger.jpg/320px-Woolly_Bugger.jpg',
        'bunny leech streamer stillwater fly':
          'https://upload.wikimedia.org/wikipedia/commons/thumb/0/02/Woolly_Bugger.jpg/320px-Woolly_Bugger.jpg',
      };

      // Try curated URL first, then fall back to Wikimedia search for unknown queries
      const curatedUrl = FLY_IMG[flyQuery];
      if (curatedUrl) {
        setImgUrl(curatedUrl);
        setLoading(false);
      } else {
        // Fallback: Wikimedia search for any query not in the curated map
