...
const FLY_INFO = {
  ...
  'Stimulator':      { insect: 'Stonefly / Caddis Attractor Dry', type: 'stonefly',
    ...
    stage: 'Adult', sizes: '#6–10', season: 'Jun–Sep', technique: 'Dead drift or skated across riffles and pocket water.',
    hook: 'Dry fly — 2XL curved shank',
    hatchTimes: { label:'Afternoon–Evening', start:13, end:20, peak:17, allDay:false, note:'Most active during warm afternoon hatches. Fish the fast water.' },
    notes: 'One of the most versatile attractor dries in the Mountain West. Covers Salmonfly, caddis, and hopper situations.' },
  'Salmonfly':       { insect: 'Giant Stonefly Adult (Pteronarcys)', type: 'stonefly',
    lifecycle: 'Adults emerge in massive hatches May–Jul and return to banks to mate and lay eggs.',
    stage: 'Adult', sizes: '#2–6', season: 'May–Jul', technique: 'Dead drift near willow-lined banks, or swing through riffles at dusk.',
    hook: 'Dry fly — 4XL',
    hatchTimes: { label:'Afternoon–Dusk', start:14, end:21, peak:18, allDay:false, note:'Peak emergence is late afternoon into evening. Fish the banks.' },
    notes: 'The most anticipated hatch in the Mountain West. Fish tight to the banks where adults congregate in willows.' },
  'BWO (Dry)':       { insect: 'Blue Wing Olive Adult Dun', type: 'mayfly',
    lifecycle: 'Adults emerge from nymphs at the surface — key feeding stage on overcast days.',
    stage: 'Adult Dun', sizes: '#16–22', season: 'Mar–May, Sep–Nov', technique: 'Drag-free drift in flat water. Match the hatch precisely — size and color critical.',
    hook: 'Dry fly — standard',
    hatchTimes: { label:'Midday–Afternoon', start:10, end:16, peak:13, allDay:false, note:'Hatches heaviest on overcast, rainy, or cold days.' },
    notes: 'Thrives in overcast, rainy conditions. Fishing is often best when it looks worst outside.' },
  'PMD':             { insect: 'Pale Morning Dun Nymph', type: 'mayfly',
    lifecycle: 'Nymph drifts subsurface before emerging — highly available to trout.',
    stage: 'Nymph', sizes: '#16–18', season: 'Jun–Aug', technique: 'Dead drift under indicator or euro rig near the bottom.',
    hook: 'Scud / curved nymph',
    hatchTimes: { label:'Morning', start:7, end:11, peak:9, allDay:false, note:'Nymphs most active in early morning before emergence.' },
    notes: 'PMD nymphs are among the most important summer patterns on Mountain West tailwaters.' },
  'PMD (Dry)':       { insect: 'Pale Morning Dun Adult Dun', type: 'mayfly',
    lifecycle: 'Adult dun emerges mid-morning — one of the most important summer dry fly hatches.',
    stage: 'Adult Dun', sizes: '#16–18', season: 'Jun–Aug', technique: 'Precise drag-free presentation to rising fish in flat tailouts.',
    hook: 'Dry fly — standard',
    hatchTimes: { label:'Morning', start:8, end:12, peak:10, allDay:false, note:'Best emergence 9–11am on warm summer mornings.' },
    notes: 'Fish flat edges of riffles and slow tailouts where rising fish collect.' },
  'Brown Drake':     { insect: 'Brown Drake Mayfly (Ephemera simulans)', type: 'mayfly',
    ...
    stage: 'Adult Dun', sizes: '#10–12', season: 'Jun–Jul', technique: 'Evening dry fly — fish rising fish during spinner falls at dusk.',
    hook: 'Dry fly — 2XL',
  ...
  'Trico':           { insect: 'Tricorythodes Mayfly (Trico)', type: 'mayfly',
    lifecycle: 'Tiny mayfly — massive morning spinner falls in late summer.',
    stage: 'Spinner', sizes: '#20–24', season: 'Jul–Sep', technique: 'Fine tippet (6X–7X), dead drift during morning spinner falls.',
    hook: 'Dry fly — standard',
    hatchTimes: { label:'Morning', start:7, end:11, peak:9, allDay:false, note:'Spinner falls happen like clockwork 8–10am on warm summer mornings.' },
    notes: 'The hardest matching game in trout fishing. Tiny size demands perfect presentation and fine tippet.' },
  'Stonefly Nymph':  { insect: 'General Stonefly Nymph (Plecoptera)', type: 'stonefly',
    lifecycle: 'Stonefly nymphs live 1–3 years on the stream bottom — always available to trout.',
    stage: 'Nymph', sizes: '#8–14', season: 'Year-round', technique: 'Dead drift tight to the bottom with split shot. High-stick through pocket water.',
    hook: 'Nymph — 2XL',
    hatchTimes: { label:'All day', start:0, end:23, peak:10, allDay:true, note:'Year-round bottom dweller — most effective in high flows.' },
    notes: 'A reliable year-round pattern. Stonefly nymphs dislodge and drift during high water and after rainstorms.' },
  'Ant':             { insect: 'Carpenter Ant / Black Ant', type: 'terrestrial',
    lifecycle: 'Terrestrial — falls on the water surface during summer. Trout key on them.',
    stage: 'Terrestrial (on water)', sizes: '#14–18', season: 'Jun–Sep', technique: 'Dead drift near overhanging vegetation, grassy banks.',
    hook: 'Dry fly — standard',
    hatchTimes: { label:'Afternoon', start:12, end:18, peak:14, allDay:false, note:'Most falls occur in warm afternoon hours.' },
    notes: 'Ant patterns are underrated. Fish them on calm summer afternoons near grassy banks and in the film.' },
  'Ant (Dry)':       { insect: 'Flying Ant', type: 'terrestrial',
    lifecycle: 'Flying ant falls are sporadic but trigger intense feeding frenzies.',
    stage: 'Terrestrial (on water)', sizes: '#14–18', season: 'Jul–Sep', technique: 'Dead drift on any flat water section during a fall.',
    hook: 'Dry fly — standard',
    hatchTimes: { label:'Afternoon', start:12, end:18, peak:15, allDay:false, note:'Flying ant falls are sporadic — be ready when you see them.' },
    notes: 'Flying ant falls can trigger some of the most intense surface feeding of the season.' },
  'Hopper (Dry)':    { insect: 'Grasshopper', type: 'terrestrial',
    lifecycle: 'Grasshoppers fall from streamside vegetation into the water — prime Aug–Sep.',
    stage: 'Terrestrial (on water)', sizes: '#6–10', season: 'Jul–Sep', technique: 'Cast tight to grassy banks. Add a small dropper nymph below.',
    hook: 'Dry fly — 2XL foam',
    hatchTimes: { label:'Midday–Afternoon', start:11, end:17, peak:14, allDay:false, note:'Peak falls happen when wind picks up on warm afternoons.' },
    notes: 'The hopper-dropper rig is one of the most effective summer setups. Use 3X tippet minimum.' },
  'Caddis Dry':      { insect: 'Caddis Adult (Trichoptera)', type: 'caddis',
    lifecycle: 'Adults skitter on the surface during evening hatches.',
    stage: 'Adult', sizes: '#14–18', season: 'May–Sep', technique: 'Drag-free or with a slight twitch to imitate skating adult.',
    hook: 'Dry fly — standard',
    hatchTimes: { label:'Evening', start:17, end:21, peak:19, allDay:false, note:'Caddis hatches peak in the evening hours.' },
    notes: 'Evening caddis hatches can be explosive. A slight drag or skate often triggers strikes when dead drift fails.' },
  'October Caddis (Dry)': { insect: 'October Caddis Adult (Dicosmoecus)', type: 'caddis',
    lifecycle: 'Large fall caddis — one of the last major hatches of the season.',
    stage: 'Adult', sizes: '#6–8', season: 'Sep–Nov', technique: 'Dead drift or skated near log jams, boulders, and banks.',
    hook: 'Dry fly — 2XL',
    hatchTimes: { label:'Afternoon', start:13, end:18, peak:15, allDay:false, note:'Afternoon sun triggers October Caddis activity.' },
    notes: 'October Caddis adults are huge — matching the size matters more than color. Fish afternoons into dusk.' },
  'RS2':             { insect: 'BWO / Midge Emerger', type: 'mayfly',
    lifecycle: 'Slim emerger pattern deadly in the film during BWO and midge hatches.',
    stage: 'Emerger / Cripple', sizes: '#18–22', season: 'Mar–May, Sep–Nov', technique: 'Dead drift in or just below the film. Long fluorocarbon tippet.',
    hook: 'Scud / curved',
    hatchTimes: { label:'Midday', start:10, end:15, peak:12, allDay:false, note:'Most effective during the peak of BWO emergence.' },
    notes: 'One of the most proven tailwater emerger patterns. Fish it when you see subtle sipping rises.' },
  'Pink Egg':        { insect: 'Egg Pattern (Spawn)', type: 'attractor',
    lifecycle: 'Imitates loose eggs during trout spawn — fish target them opportunistically.',
    stage: 'Egg', sizes: '#10–14', season: 'Sep–Nov (fall spawn)', technique: 'Dead drift near spawning beds. Light tippet in clear water.',
    hook: 'Egg hook — wide gap',
    hatchTimes: { label:'All day', start:0, end:23, peak:10, allDay:true, note:'Effective all day during spawn season.' },
    notes: 'Most effective during fall brown and brook trout spawn. Fish downstream of spawning redds ethically.' },
  'Sow Bug':         { insect: 'Aquatic Sowbug / Isopod', type: 'stillwater',
    lifecycle: 'Crustacean — lives among rocks and vegetation in tailwaters and spring creeks year-round.',
    stage: 'Nymph', sizes: '#14–18', season: 'Year-round', technique: 'Dead drift on the bottom in spring creeks and tailwaters.',
    hook: 'Scud hook',
    hatchTimes: { label:'All day', start:0, end:23, peak:10, allDay:true, note:'Available year-round — most effective in slow, clear water.' },
    notes: 'Sowbugs are staple food in rich tailwaters like the Green River and Provo. Gray or tan colors work best.' },
  'Olive Sculpin':   { insect: 'Sculpin / Bottom Baitfish', type: 'streamer',
    lifecycle: 'Bottom-dwelling baitfish — large trout ambush them near rocks and structure.',
    stage: 'Sculpin / Bottom Baitfish', sizes: '#2–6', season: 'Year-round', technique: 'Strip along the bottom near boulders, log jams, and undercut banks.',
    hook: 'Streamer — 4XL',
    hatchTimes: { label:'Low light', start:5, end:9, peak:7, allDay:false, note:'Most effective in early morning and evening low-light periods.' },
    notes: 'Sculpin patterns excel in high flows and low light. Bounce them along the bottom with short strips.' },
  'San Juan Worm': {
...
const INSECT_TAXON = {
  ...
  'stillwater|Adult Dun':           'Callibaetis',
  'stillwater|Spinner':             'Callibaetis',
  'stillwater|Emerger / Cripple':   'Callibaetis',
  'stillwater|Larva':               'Chironomidae',
  'stillwater|Pupa':                'Chironomidae',
  'stillwater|Adult / Emerger':     'Chironomus plumosus',
  'euro_nymph|Nymph':               'Baetidae',
  'euro_nymph|Larva':               'Chironomidae',
  'euro_nymph':                     'Baetidae',
...
const FLY_SEARCH = {
  ...
  'Midge Larva':            'chironomid midge larva fly pattern',
  'Midge Pupa':             'chironomid pupa fly fishing pattern',
  'Midge Cluster':          'Griffith Gnat midge cluster dry fly',
  'Rainbow Warrior':        'Rainbow Warrior nymph fly tying pattern',
  'Blowtorch':              'Frenchie nymph euro fly pattern tying',
  // ── BWO / Mayfly ──
  'BWO Nymph':              'Pheasant tail nymph fly fishing',
  'BWO Emerger':            'blue winged olive emerger fly pattern',
  'BWO RS2':                'RS2 emerger fly fishing tailwater pattern',
  'BWO (Dry)':              'blue winged olive dry fly parachute pattern',
  'Pheasant Tail':          'Pheasant tail nymph fly fishing',
  'Frenchie':               'Frenchie nymph fly pattern tying bead',
  'Perdigon':               'Perdigon nymph euro fly pattern tying',
  // ── PMD ──
  'PMD Nymph':              'Pheasant tail nymph fly fishing',
  'PMD Sparkle Dun':        'sparkle dun pale morning dun fly pattern',
  'PMD':                    'Pheasant tail nymph fly fishing',
  'PMD (Dry)':              'pale morning dun dry fly parachute pattern',
  // ── Caddis ──
  'Caddis Larva':           'caddis larva fly fishing pattern tying',
  'Caddis Pupa':            'caddis pupa fly fishing pattern soft hackle',
  'Elk Hair Caddis':        'Elk Hair Caddis dry fly fly fishing',
  'Soft Hackle Caddis':     'soft hackle wet fly caddis pattern',
  'October Caddis':         'October caddis fly pattern large orange',
  'Caddis Dry':             'Elk Hair Caddis dry fly fly fishing',
  'October Caddis (Dry)':   'October caddis dry fly pattern large',
  // ── Stoneflies ──
  'Skwala Stone':           'stonefly nymph fly fishing rubber legs pattern',
  'Skwala Nymph':           'stonefly nymph fly fishing rubber legs pattern',
  'Salmonfly Nymph':        'Pteronarcys californica stonefly nymph',
  'Salmonfly':              'Stimulator fly fishing dry fly attractor',
  'Stimulator':             'Stimulator fly fishing dry fly attractor',
  'Yellow Sally':           'yellow stonefly dry fly pattern fishing',
  'Stonefly Nymph':         'stonefly nymph fly fishing rubber legs pattern',
  // ── Terrestrials ──
  'Hopper':                 'grasshopper hopper fly fishing dry fly',
  'Chubby Chernobyl':       'chubby chernobyl foam dry fly attractor',
  'Hopper (Dry)':           'grasshopper hopper fly fishing dry fly',
  'Ant':                    'ant terrestrial fly fishing dry fly pattern',
  'Ant (Dry)':              'ant flying ant dry fly pattern fishing',
  // ── Streamers ──
  'Woolly Bugger':          'Woolly Bugger streamer fly fishing pattern',
  'Articulated Leech':      'articulated streamer leech fly fishing',
  'Slumpbuster':            'sculpin streamer fly fishing pattern',
  'Circus Peanut':          'articulated streamer fly fishing large pattern',
  'Drunk & Disorderly':     'articulated streamer trout fly pattern',
  'Olive Sculpin':          'sculpin streamer fly fishing bottom pattern',
  // ── Euro / Attractor nymphs ──
  'Frenchie':               'Frenchie nymph fly pattern tying bead',
  'Perdigon':               'Perdigon nymph euro fly pattern tying',
  'RS2':                    'RS2 emerger fly fishing tailwater pattern',
  'Pink Egg':               'San Juan Worm egg fly fishing pattern',
  'Sow Bug':                'scud freshwater shrimp fly fishing pattern',
  // ── Stillwater ──
  'Callibaetis':            'callibaetis mayfly nymph speckled wing dun',
  'Damsel Nymph':           'damselfly nymph fly fishing stillwater pattern',
  'Scud':                   'scud freshwater shrimp fly fishing pattern',
  'San Juan Worm':          'San Juan Worm red fly fishing pattern trout',
  // ── Other mayfly dries ──
  'Brown Drake':            'brown drake mayfly dry fly fishing pattern',
  'Trico':                  'trico mayfly spinner dry fly fishing',
  'Stimulator':             'Stimulator fly fishing dry fly attractor',
  'Salmonfly':              'Stimulator fly fishing dry fly attractor',
...
const FLY_FILES = {
  'Zebra Midge':           'File:Zebra midge fly.jpg',
  'Midge Larva':           'File:Midge larva fly pattern.jpg',
  'Midge Pupa':            'File:Chironomid pupa fly pattern.jpg',
  'Midge Cluster':         'File:Zebra midge fly.jpg',
  'BWO Nymph':             'File:Pheasant Tail Nymph fly.jpg',
  'BWO Emerger':           'File:BWO emerger fly pattern.jpg',
  'BWO RS2':               'File:RS2 fly pattern.jpg',
  'BWO (Dry)':             'File:Blue-winged olive (fly).jpg',
  'PMD Nymph':             'File:Pheasant Tail Nymph fly.jpg',
  'PMD Sparkle Dun':       'File:PMD sparkle dun fly pattern.jpg',
  'PMD':                   'File:Pheasant Tail Nymph fly.jpg',
  'PMD (Dry)':             'File:Pale morning dun fly pattern.jpg',
  'Pheasant Tail':         'File:Pheasant Tail Nymph fly.jpg',
  'Caddis Larva':          'File:Caddis larva fly pattern.jpg',
  'Caddis Pupa':           'File:Caddis pupa fly pattern.jpg',
  'Elk Hair Caddis':       'File:Elk Hair Caddis dry flies.jpg',
  'Soft Hackle Caddis':    'File:Soft hackle wet fly.jpg',
  'October Caddis':        'File:October caddis fly pattern.jpg',
  'Caddis Dry':            'File:Elk Hair Caddis dry flies.jpg',
  'October Caddis (Dry)':  'File:October caddis fly pattern.jpg',
  'Skwala Stone':          'File:Skwala stonefly nymph pattern.jpg',
  'Skwala Nymph':          'File:Skwala stonefly nymph pattern.jpg',
  'Salmonfly Nymph':       'File:Kaufmann Stone fly pattern dark.jpg',
  'Salmonfly':             'File:Stimulator fly (fly fishing).jpg',
  'Stimulator':            'File:Stimulator fly (fly fishing).jpg',
  'Yellow Sally':          'File:Yellow Sally stonefly dry fly.jpg',
  'Stonefly Nymph':        'File:Kaufmann Stone fly pattern dark.jpg',
  'Hopper':                'File:Dave\'s Hopper fly pattern.jpg',
  'Chubby Chernobyl':      'File:Chubby Chernobyl fly pattern.jpg',
  'Hopper (Dry)':          'File:Dave\'s Hopper fly pattern.jpg',
  'Ant':                   'File:Foam ant fly pattern.jpg',
  'Ant (Dry)':             'File:Foam ant fly pattern.jpg',
  'Frenchie':              'File:Frenchie nymph fly pattern.jpg',
  'Perdigon':              'File:Perdigon nymph fly.jpg',
  'Rainbow Warrior':       'File:Rainbow Warrior nymph fly pattern.jpg',
  'Blowtorch':             'File:Frenchie nymph fly pattern.jpg',
  'Woolly Bugger':         'File:Black Woolly Bugger by James Stripes.jpg',
  'Articulated Leech':     'File:Articulated streamer fly pattern.jpg',
  'Slumpbuster':           'File:Slumpbuster streamer fly pattern.jpg',
  'Circus Peanut':         'File:Articulated streamer fly pattern.jpg',
  'Drunk & Disorderly':    'File:Articulated streamer fly pattern.jpg',
  'Conehead Sculpin':      'File:Sculpin streamer fly pattern.jpg',
  'Olive Sculpin':         'File:Sculpin streamer fly pattern.jpg',
  'Callibaetis':           'File:Callibaetis fly pattern nymph.jpg',
  'Damsel Nymph':          'File:Damsel nymph fly pattern.jpg',
  'Scud':                  'File:Scud freshwater shrimp fly pattern.jpg',
  'Sow Bug':               'File:Scud freshwater shrimp fly pattern.jpg',
  'San Juan Worm':         'File:San Juan Worm fly pattern red.jpg',
  'Pink Egg':              'File:Egg fly pattern spawn.jpg',
  'RS2':                   'File:RS2 fly pattern.jpg',
  'Brown Drake':           'File:Brown drake mayfly dry fly.jpg',
  'Trico':                 'File:Trico spinner dry fly pattern.jpg',
  'Stonefly Nymph':        'File:Kaufmann Stone fly pattern dark.jpg',
};
...
function FlyImage({ taxon, flyFile, type, label, size = 120 }) {
  ...
  useEffect(() => {
    ...
    if (taxon) {
      ...
      // Wikimedia Commons search — finds best matching image by query string
      ...
      fetch(`https://commons.wikimedia.org/w/api.php?action=query&list=search&srsearch=${encodeURIComponent(flyFile)}&srnamespace=6&srlimit=5&format=json&origin=*`)
        .then(r => r.json())
        .then(data => {
          if (cancelled) return;
          // Filter to image files only (jpg/png/svg)
          const hits = (data?.query?.search || [])
            .filter(h => /\.(jpe?g|png|svg)/i.test(h.title) && !/\.pdf/i.test(h.title));
          if (!hits.length) throw new Error('no results');
          // Step 2: get the image URL for the best hit
          ...
          return fetch(`https://commons.wikimedia.org/w/api.php?action=query&titles=${encodeURIComponent(title)}&prop=imageinfo&iiprop=url&iiurlwidth=${size * 2}&format=json&origin=*`)
            ...
            .then(d => {
              ...
              if (url) {
                if (!FlyImage._cache) FlyImage._cache = {};
        ...
        .catch(() => {
          if (!cancelled) {
            if (!FlyImage._cache) FlyImage._cache = {};
            FlyImage._cache[flyFile] = null; // cache miss to avoid retries
              ...
              {!info ? (
                ...
                <>
                  ...
                  {(() => {
                    ...
                    const flyQ = FLY_FILES[key] || FLY_FILES[flyName] || null;
                    return (
