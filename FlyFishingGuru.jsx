...
const RIVER_SPECIES = {
  UT: {
    'Provo River':     ['rainbow','brown','whitefish'],
  ...
  ID: {
    ...
    'Salmon River':     ['steelhead','chinook','rainbow','cutthroat'],
    'Clearwater River': ['steelhead','chinook','rainbow'],
  },
  WY: {
    'Snake River (WY)':  ['cutthroat','rainbow','brown','whitefish'],
    'Green River (WY)':  ['rainbow','brown','cutthroat'],
    'North Platte River':['rainbow','brown'],
    'Hoback River':      ['cutthroat','brown'],
    "Ham's Fork":        ['brown','rainbow','cutthroat'],
    'Wind River':        ['rainbow','brown','cutthroat','whitefish'],
    'Shoshone River':    ['rainbow','brown','whitefish'],
  },
  MT: {
    'Madison River':     ['rainbow','brown','whitefish'],
    'Yellowstone River': ['cutthroat','rainbow','brown','whitefish'],
    'Bighorn River':     ['rainbow','brown','whitefish'],
    'Gallatin River':    ['rainbow','brown','cutthroat'],
    'Missouri River':    ['rainbow','brown','whitefish'],
    'Clark Fork':        ['rainbow','brown','bull','whitefish'],
    'Bitterroot River':  ['rainbow','brown','cutthroat'],
  },
  CO: {
    'Arkansas River':    ['rainbow','brown'],
    'South Platte':      ['rainbow','brown'],
    'Frying Pan River':  ['rainbow','brown'],
    'Blue River':        ['rainbow','brown'],
    'Roaring Fork':      ['rainbow','brown','cutthroat'],
    'Cache la Poudre':   ['rainbow','brown','cutthroat'],
  },
  OR: {
    ...
    'Sandy River':       ['steelhead','cutthroat'],
    'John Day River':    ['rainbow','steelhead'],
    'Williamson River':  ['rainbow','brown'],
  },
  WA: {
    'Yakima River':      ['rainbow','brown','whitefish'],
    'Methow River':      ['steelhead','rainbow','cutthroat'],
    'Skagit River':      ['steelhead','chinook','coho','cutthroat'],
    'Klickitat River':   ['steelhead','rainbow'],
    'Wenatchee River':   ['steelhead','rainbow','cutthroat'],
    'Spokane River':     ['rainbow','brown','cutthroat'],
  },
  brown: {
...
const F = {
  Ant: {t:'n',n:'Ant'},
  AntDry: {t:'n',n:'Ant (Dry)'},
  ArticulatedLeech: {t:'r',n:'Articulated Leech'},
  BwoDry: {t:'s',n:'BWO (Dry)'},
  BwoEmerger: {t:'n',n:'BWO Emerger'},
  BwoNymph: {t:'n',n:'BWO Nymph'},
  BwoNymphTiny: {t:'n',n:'BWO Nymph (Tiny)'},
  BwoRs2: {t:'n',n:'BWO RS2'},
  Blowtorch: {t:'e',n:'Blowtorch'},
  Blowtorch20: {t:'e',n:'Blowtorch #20'},
  BrownDrake: {t:'s',n:'Brown Drake'},
  BunnyLeech: {t:'r',n:'Bunny Leech'},
  CaddisDryFly: {t:'s',n:'Caddis (Dry)'},
  CaddisDry: {t:'s',n:'Caddis Dry'},
  CaddisLarva: {t:'n',n:'Caddis Larva'},
  CaddisPupa: {t:'s',n:'Caddis Pupa'},
  Callibaetis: {t:'n',n:'Callibaetis'},
  CallibaetisDry: {t:'n',n:'Callibaetis (Dry)'},
  CallibaetisNymph: {t:'n',n:'Callibaetis Nymph'},
  Chironomid: {t:'e',n:'Chironomid'},
  ChubbyChernobyl: {t:'s',n:'Chubby Chernobyl'},
  CircusPeanut: {t:'r',n:'Circus Peanut'},
  ConeheadSculpin: {t:'r',n:'Conehead Sculpin'},
  DamselNymph: {t:'s',n:'Damsel Nymph'},
  DrunkDisorderly: {t:'r',n:'Drunk & Disorderly'},
  EggPattern: {t:'r',n:'Egg Pattern'},
  ElkHairCaddis: {t:'n',n:'Elk Hair Caddis'},
  EstazEgg: {t:'r',n:'Estaz Egg'},
  Frenchie: {t:'e',n:'Frenchie'},
  Frenchie18: {t:'e',n:'Frenchie #18'},
  GoldenStone: {t:'s',n:'Golden Stone'},
  Hopper: {t:'n',n:'Hopper'},
  HopperDry: {t:'s',n:'Hopper (Dry)'},
  HopperAttractor: {t:'n',n:'Hopper / Attractor'},
  Hoppers: {t:'n',n:'Hoppers'},
  MahoganyDun: {t:'n',n:'Mahogany Dun'},
  MidgeCluster: {t:'n',n:'Midge Cluster'},
  MidgeLarva: {t:'n',n:'Midge Larva'},
  MidgeLarvaTiny: {t:'n',n:'Midge Larva (Tiny)'},
  MidgePupa: {t:'n',n:'Midge Pupa'},
  OctoberCaddis: {t:'s',n:'October Caddis'},
  OctoberCaddisBig: {t:'n',n:'October Caddis (Big)'},
  OctoberCaddisDry: {t:'s',n:'October Caddis (Dry)'},
  OliveSculpin: {t:'r',n:'Olive Sculpin'},
  Pmd: {t:'n',n:'PMD'},
  PmdDry: {t:'n',n:'PMD (Dry)'},
  PmdTinyDry: {t:'n',n:'PMD (Tiny Dry)'},
  PmdNymph: {t:'n',n:'PMD Nymph'},
  PmdSparkleDun: {t:'n',n:'PMD Sparkle Dun'},
  Perdigon: {t:'e',n:'Perdigon'},
  Perdigon20: {t:'e',n:'Perdigon #20'},
  PerdigonBlack: {t:'e',n:'Perdigon (Black)'},
  PerdigonOlive: {t:'e',n:'Perdigon (Olive)'},
  PerdigonRed: {t:'e',n:'Perdigon (Red)'},
  PheasantTail: {t:'n',n:'Pheasant Tail'},
  PheasantTail18: {t:'n',n:'Pheasant Tail #18'},
  PinkEgg: {t:'r',n:'Pink Egg'},
  PinkWorm: {t:'r',n:'Pink Worm'},
  Rs2: {t:'e',n:'RS2'},
  RainbowWarrior: {t:'e',n:'Rainbow Warrior'},
  RainbowWarrior22: {t:'e',n:'Rainbow Warrior #22'},
  Salmonfly: {t:'s',n:'Salmonfly'},
  SalmonflyDry: {t:'s',n:'Salmonfly (Dry)'},
  SalmonflyNymph: {t:'s',n:'Salmonfly Nymph'},
  SanJuanWorm: {t:'n',n:'San Juan Worm'},
  Scud: {t:'n',n:'Scud'},
  SkwalaDry: {t:'s',n:'Skwala (Dry)'},
  SkwalaNymph: {t:'s',n:'Skwala Nymph'},
  SkwalaStone: {t:'s',n:'Skwala Stone'},
  Slumpbuster: {t:'r',n:'Slumpbuster'},
  SlumpbusterSmall: {t:'r',n:'Slumpbuster (Small)'},
  SoftHackle: {t:'n',n:'Soft Hackle'},
  SoftHackleCaddis: {t:'n',n:'Soft Hackle Caddis'},
  SowBug: {t:'n',n:'Sow Bug'},
  Stimulator: {t:'s',n:'Stimulator'},
  StimulatorDry: {t:'s',n:'Stimulator (Dry)'},
  StoneflyNymph: {t:'n',n:'Stonefly Nymph'},
  StoneflyNymphDark: {t:'s',n:'Stonefly Nymph (Dark)'},
  Trico: {t:'n',n:'Trico'},
  TricoDry: {t:'n',n:'Trico (Dry)'},
  TricoNymph: {t:'n',n:'Trico Nymph'},
  WoollyBugger: {t:'r',n:'Woolly Bugger'},
  WoollyBuggerLarge: {t:'r',n:'Woolly Bugger (Large)'},
  WoollyBuggerOlive: {t:'r',n:'Woolly Bugger (Olive)'},
  WoollyBuggerSmall: {t:'r',n:'Woolly Bugger (Small)'},
  YellowSally: {t:'s',n:'Yellow Sally'},
  ZebraMidge: {t:'n',n:'Zebra Midge'},
  ZebraMidge20: {t:'n',n:'Zebra Midge #20'},
  ZebraMidgeJig: {t:'e',n:'Zebra Midge Jig'},
};
...
// Search terms for Wikimedia Commons, keyed by "type|stage" or "type"
const INSECT_SEARCH = {
  'midge|Larva':               'Chironomidae larva aquatic insect',
  'midge|Pupa':                'Chironomidae pupa aquatic',
  'midge|Adult / Emerger':     'Chironomus plumosus adult midge',
  'mayfly|Nymph':              'Baetis nymph mayfly aquatic',
  'mayfly|Emerger / Cripple':  'mayfly emerging surface water',
  'mayfly|Adult Dun':          'Baetis rhodani mayfly dun',
  'mayfly|Spinner':            'mayfly spinner spent wing',
  'caddis|Larva':              'Trichoptera larva caddisfly case',
  'caddis|Pupa':               'caddisfly pupa emerger aquatic',
  'caddis|Adult':              'caddisfly adult Trichoptera wing',
  'caddis|Adult (Egg-Laying)': 'caddisfly ovipositing adult water',
  'stonefly|Nymph':            'Plecoptera nymph stonefly aquatic',
  'stonefly|Nymph (2–3 Year)': 'Pteronarcys californica nymph large',
  'stonefly|Nymph (Pre-Emergence)':'stonefly nymph shore migration',
  'stonefly|Adult':            'Pteronarcys californica adult stonefly',
  'stonefly|Adult (Egg-Laying)':'stonefly adult female ovipositing',
  'terrestrial|Terrestrial (on water)':'grasshopper water surface trout',
  'streamer|Large Attractor / Baitfish':'sculpin fish stream rocky bottom',
  'streamer|Leech':            'leech aquatic Hirudinea',
  'streamer|Sculpin / Bottom Baitfish':'Cottus sculpin fish stream',
  'stillwater|Nymph':         'Callibaetis mayfly nymph stillwater',
};

// Artificial fly search terms keyed by fly name
const FLY_SEARCH = {
  'Zebra Midge':       'Zebra Midge fly fishing pattern tying',
  'Midge Larva':       'midge larva fly fishing pattern red',
  'Midge Pupa':        'midge pupa fly fishing pattern emerge',
  'Midge Cluster':     "Griffith's Gnat midge cluster fly pattern",
  'BWO Nymph':         'BWO nymph Blue Wing Olive fly pattern',
  'BWO Emerger':       'Blue Wing Olive emerger CDC fly pattern',
  'BWO RS2':           'RS2 fly pattern emerger tailwater',
  'PMD Nymph':         'PMD nymph Pale Morning Dun fly pattern',
  'PMD Sparkle Dun':   'PMD Sparkle Dun dry fly pattern',
  'Pheasant Tail':     'Pheasant Tail nymph fly pattern bead head',
  'Frenchie':          'Frenchie fly pattern euro nymph',
  'Rainbow Warrior':   'Rainbow Warrior fly pattern midge',
  'Blowtorch':         'Blowtorch fly pattern midge euro',
  'Elk Hair Caddis':   'Elk Hair Caddis dry fly pattern',
  'Caddis Larva':      'caddis larva fly pattern green body',
  'Caddis Pupa':       'caddis pupa wet fly pattern soft hackle',
  'Soft Hackle Caddis':'soft hackle wet fly caddis pattern',
  'October Caddis':    'October Caddis large dry fly orange',
  'Skwala Stone':      'Skwala stonefly dry fly pattern',
  'Skwala Nymph':      'Skwala stonefly nymph fly pattern',
  'Salmonfly Nymph':   'Salmonfly Pteronarcys nymph pattern large',
  'Yellow Sally':      'Yellow Sally stonefly dry fly pattern',
  'Stimulator':        'Stimulator fly dry attractor stonefly',
  'Hopper':            'grasshopper hopper dry fly Dave Dave pattern',
  'Chubby Chernobyl':  'Chubby Chernobyl foam dry fly attractor',
  'San Juan Worm':     'San Juan Worm fly pattern red annelid',
  'Woolly Bugger':     'Woolly Bugger streamer fly pattern olive',
  'Slumpbuster':       'Slumpbuster streamer fly pattern pine squirrel',
  'Articulated Leech': 'articulated leech streamer fly pattern',
  'Circus Peanut':     'Circus Peanut streamer articulated fly',
  'Drunk & Disorderly':'streamer articulated fly pattern trout',
};
...
function InsectSVG({ type }) {
  ...
  const col = { midge:'#4db8a8',mayfly:'#8a9fdf',caddis:'#6fc48a',stonefly:'#d4a855',
                terrestrial:'#e9c46a',streamer:'#e08060',euro_nymph:'#8a9fdf',
                attractor:'#9ab870',stillwater:'#4db8a8' };
  const c = col[type] || '#4dbfaf';
  return (
...
// FlyImage component — fetches from Wikimedia Commons API, shows SVG fallback
function FlyImage({ query, type, label, size = 120 }) {
  const [imgUrl, setImgUrl] = useState(null);
  const [loading, setLoading] = useState(true);
  const [err, setErr] = useState(false);

  useEffect(() => {
    if (!query) { setLoading(false); setErr(true); return; }
    setLoading(true); setErr(false); setImgUrl(null);

    const encoded = encodeURIComponent(query);
    fetch(
      `https://en.wikipedia.org/w/api.php?action=query&list=search&srsearch=${encoded}&srnamespace=6&srlimit=1&format=json&origin=*`
    )
      .then(r => r.json())
      .then(data => {
        ...
        return fetch(
          `https://en.wikipedia.org/w/api.php?action=query&titles=${encodeURIComponent(title)}&prop=imageinfo&iiprop=url&iiurlwidth=${size * 2}&format=json&origin=*`
        );
      })
      .then(r => r.json())
      .then(data => {
        ...
        if (url) { setImgUrl(url); setLoading(false); }
  ...
  const boxStyle = {
    width: size, height: size, maxWidth:'100%', aspectRatio:'1', borderRadius: 4, overflow:'hidden',
...
const STILLWATER_H = {
  UT: {
    'Strawberry Reservoir': [[F.MidgeLarva,F.Scud],[F.MidgeLarva,F.Scud],[F.MidgePupa,F.CallibaetisNymph],[F.CallibaetisNymph,F.Chironomid],[F.Callibaetis,F.Chironomid,F.DamselNymph],[F.CallibaetisDry,F.DamselNymph,F.Chironomid],[F.CallibaetisDry,F.DamselNymph,F.BunnyLeech],[F.CallibaetisDry,F.WoollyBugger,F.Chironomid],[F.Callibaetis,F.ArticulatedLeech,F.MidgePupa],[F.MidgePupa,F.WoollyBugger],[F.MidgeLarva,F.Scud],[F.MidgeLarva,F.Scud]],
    'Flaming Gorge': [[F.MidgeLarva,F.Slumpbuster],[F.MidgeLarva,F.Slumpbuster],[F.MidgePupa,F.WoollyBugger],[F.MidgePupa,F.CallibaetisNymph,F.WoollyBugger],[F.DamselNymph,F.Callibaetis,F.ArticulatedLeech],[F.DamselNymph,F.CallibaetisDry,F.CircusPeanut],[F.CallibaetisDry,F.WoollyBuggerLarge,F.Scud],[F.CallibaetisDry,F.ArticulatedLeech,F.HopperAttractor],[F.CircusPeanut,F.Callibaetis,F.MidgePupa],[F.DrunkDisorderly,F.MidgePupa],[F.MidgeLarva,F.WoollyBugger],[F.MidgeLarva,F.WoollyBugger]],
  },
  ID: {
    "Henry's Lake": [[F.MidgeLarva,F.BunnyLeech],[F.MidgeLarva,F.BunnyLeech],[F.MidgePupa,F.WoollyBugger],[F.CallibaetisNymph,F.DamselNymph,F.WoollyBugger],[F.Callibaetis,F.DamselNymph,F.ArticulatedLeech],[F.CallibaetisDry,F.DamselNymph,F.BunnyLeech],[F.CallibaetisDry,F.WoollyBuggerLarge,F.DamselNymph],[F.Callibaetis,F.ArticulatedLeech],[F.CircusPeanut,F.MidgePupa],[F.WoollyBugger,F.MidgePupa],[F.MidgeLarva,F.BunnyLeech],[F.MidgeLarva,F.BunnyLeech]],
  },
  WY: {
    'Fremont Lake': [[F.MidgeLarva,F.WoollyBugger],[F.MidgeLarva,F.WoollyBugger],[F.MidgePupa,F.ArticulatedLeech],[F.CallibaetisNymph,F.WoollyBugger],[F.DamselNymph,F.Callibaetis,F.Slumpbuster],[F.CallibaetisDry,F.DamselNymph,F.CircusPeanut],[F.CallibaetisDry,F.WoollyBuggerLarge],[F.Callibaetis,F.ArticulatedLeech],[F.CircusPeanut,F.MidgePupa],[F.WoollyBugger,F.MidgePupa],[F.MidgeLarva,F.WoollyBugger],[F.MidgeLarva,F.WoollyBugger]],
  },
  MT: {
    'Flathead Lake': [[F.MidgeLarva,F.BunnyLeech],[F.MidgeLarva,F.BunnyLeech],[F.MidgePupa,F.WoollyBugger],[F.CallibaetisNymph,F.DamselNymph,F.WoollyBugger],[F.Callibaetis,F.DamselNymph,F.ArticulatedLeech],[F.CallibaetisDry,F.DamselNymph,F.CircusPeanut],[F.CallibaetisDry,F.WoollyBuggerLarge],[F.Callibaetis,F.ArticulatedLeech],[F.CircusPeanut,F.MidgePupa],[F.DrunkDisorderly,F.MidgePupa],[F.MidgeLarva,F.WoollyBugger],[F.MidgeLarva,F.BunnyLeech]],
    'Hebgen Lake': [[F.MidgeLarva,F.WoollyBugger],[F.MidgeLarva,F.WoollyBugger],[F.MidgePupa,F.WoollyBugger],[F.CallibaetisNymph,F.Chironomid],[F.Callibaetis,F.Chironomid,F.DamselNymph],[F.CallibaetisDry,F.DamselNymph,F.Chironomid],[F.CallibaetisDry,F.BunnyLeech,F.Chironomid],[F.Callibaetis,F.ArticulatedLeech],[F.CircusPeanut,F.MidgePupa],[F.WoollyBugger,F.MidgePupa],[F.MidgeLarva,F.WoollyBugger],[F.MidgeLarva,F.WoollyBugger]],
  },
  CO: {
    'Blue Mesa Reservoir': [[F.MidgeLarva,F.WoollyBugger],[F.MidgeLarva,F.WoollyBugger],[F.MidgePupa,F.ArticulatedLeech],[F.CallibaetisNymph,F.DamselNymph,F.WoollyBugger],[F.Callibaetis,F.DamselNymph,F.Slumpbuster],[F.CallibaetisDry,F.DamselNymph,F.CircusPeanut],[F.CallibaetisDry,F.WoollyBuggerLarge],[F.Callibaetis,F.ArticulatedLeech],[F.CircusPeanut,F.MidgePupa],[F.DrunkDisorderly,F.MidgePupa],[F.MidgeLarva,F.WoollyBugger],[F.MidgeLarva,F.WoollyBugger]],
    'Spinney Mountain Reservoir': [[F.MidgeLarva,F.Scud],[F.MidgeLarva,F.Scud],[F.MidgePupa,F.CallibaetisNymph],[F.CallibaetisNymph,F.Chironomid],[F.Callibaetis,F.Chironomid,F.DamselNymph],[F.CallibaetisDry,F.DamselNymph,F.Chironomid],[F.CallibaetisDry,F.DamselNymph,F.BunnyLeech],[F.CallibaetisDry,F.WoollyBugger],[F.Callibaetis,F.ArticulatedLeech],[F.MidgePupa,F.WoollyBugger],[F.MidgeLarva,F.Scud],[F.MidgeLarva,F.Scud]],
  },
  OR: {
    'Crane Prairie Reservoir': [[F.MidgeLarva,F.WoollyBugger],[F.MidgeLarva,F.WoollyBugger],[F.MidgePupa,F.ArticulatedLeech],[F.CallibaetisNymph,F.DamselNymph],[F.Callibaetis,F.DamselNymph,F.BunnyLeech],[F.CallibaetisDry,F.DamselNymph,F.CircusPeanut],[F.CallibaetisDry,F.WoollyBuggerLarge],[F.Callibaetis,F.ArticulatedLeech],[F.CircusPeanut,F.MidgePupa],[F.WoollyBugger,F.MidgePupa],[F.MidgeLarva,F.WoollyBugger],[F.MidgeLarva,F.WoollyBugger]],
  },
  WA: {
    'Lake Lenice': [[F.MidgeLarva,F.Scud],[F.MidgeLarva,F.Scud],[F.MidgePupa,F.CallibaetisNymph],[F.CallibaetisNymph,F.Chironomid],[F.Callibaetis,F.Chironomid,F.DamselNymph],[F.CallibaetisDry,F.DamselNymph,F.Chironomid],[F.CallibaetisDry,F.DamselNymph,F.BunnyLeech],[F.CallibaetisDry,F.WoollyBugger],[F.Callibaetis,F.ArticulatedLeech],[F.MidgePupa,F.WoollyBugger],[F.MidgeLarva,F.Scud],[F.MidgeLarva,F.Scud]],
  },
};
...
const H = {
  UT:{
    ...
    data:{
      'Provo River':[[F.ZebraMidge,F.PerdigonRed,F.Slumpbuster],[F.ZebraMidge,F.Frenchie,{t:'s',n:"Pat's Rubber Legs"}],[F.BwoNymph,F.SkwalaStone,{t:'e',n:"Jig Hare's Ear"},F.WoollyBugger],[F.BwoEmerger,F.SkwalaDry,F.RainbowWarrior,F.PheasantTail],[F.SalmonflyNymph,F.CaddisLarva,F.Blowtorch,F.ConeheadSculpin],[F.StimulatorDry,F.PmdNymph,{t:'e',n:"Walt's Worm"},F.ArticulatedLeech],[F.PmdSparkleDun,F.YellowSally,F.PerdigonOlive,F.Trico],[F.TricoNymph,F.ChubbyChernobyl,F.SoftHackleCaddis,F.WoollyBugger],[F.MahoganyDun,{t:'e',n:"Jig Hare's Ear"},F.CircusPeanut,F.OctoberCaddis],[F.BwoEmerger,F.Frenchie,F.DrunkDisorderly,F.OctoberCaddisDry],[F.ZebraMidge,F.Blowtorch,F.Slumpbuster],[F.ZebraMidge,F.PerdigonRed,F.WoollyBugger]],
      'Green River':[[F.ZebraMidge,F.RainbowWarrior,F.WoollyBugger],[F.MidgeLarva,F.PerdigonRed,{t:'s',n:"Pat's Rubber Legs"}],[F.BwoNymph,F.Frenchie,{t:'s',n:"Kaufmann's Stone"},F.Slumpbuster],[F.BwoRs2,F.SkwalaStone,F.Blowtorch,F.PheasantTail],[F.SalmonflyNymph,F.CaddisLarva,{t:'e',n:"Jig Hare's Ear"},F.ConeheadSculpin],[F.StimulatorDry,F.PmdNymph,F.SanJuanWorm,F.PerdigonOlive],[F.PmdDry,F.YellowSally,{t:'e',n:"Walt's Worm"},F.Trico],[F.TricoNymph,F.ChubbyChernobyl,F.RainbowWarrior,F.WoollyBugger],[F.MahoganyDun,F.Frenchie,F.CircusPeanut,F.OctoberCaddis],[F.BwoEmerger,F.Blowtorch,F.Slumpbuster,F.CaddisPupa],[F.ZebraMidge,F.PerdigonBlack,F.ArticulatedLeech],[F.ZebraMidge,F.RainbowWarrior,F.WoollyBugger]],
      'Logan River':[[F.ZebraMidge,F.Frenchie,F.WoollyBugger],[F.MidgeLarva,{t:'e',n:"Jig Hare's Ear"},F.Slumpbuster],[F.SkwalaNymph,F.BwoNymph,F.Perdigon],[F.SkwalaDry,F.BwoRs2,F.Blowtorch,F.ConeheadSculpin],[F.SalmonflyNymph,F.ElkHairCaddis,{t:'e',n:"Walt's Worm"}],[F.Stimulator,F.PmdNymph,{t:'e',n:"Jig Hare's Ear"},F.CircusPeanut],[F.PmdDry,F.YellowSally,F.RainbowWarrior,F.AntDry],[F.ChubbyChernobyl,F.Trico,F.Frenchie,F.WoollyBugger],[F.MahoganyDun,F.OctoberCaddis,F.PerdigonOlive,F.Slumpbuster],[F.BwoEmerger,F.Blowtorch,F.ArticulatedLeech],[F.ZebraMidge,{t:'e',n:"Jig Hare's Ear"},F.WoollyBugger],[F.ZebraMidge,F.Frenchie]],
      'Weber River':[[F.ZebraMidge,F.WoollyBugger],[F.MidgeLarva,F.Frenchie,F.Slumpbuster],[F.BwoNymph,F.SkwalaNymph,F.Perdigon],[F.SkwalaDry,F.BwoRs2,F.Blowtorch,F.ConeheadSculpin],[F.GoldenStone,F.CaddisLarva,{t:'e',n:'Elk Hair Caddis'},F.CircusPeanut],[F.PmdNymph,F.CaddisDryFly,{t:'e',n:"Walt's Worm"},F.ArticulatedLeech],[F.PmdSparkleDun,F.YellowSally,F.RainbowWarrior,F.AntDry],[F.HopperDry,F.Trico,F.Frenchie,F.WoollyBugger],[F.MahoganyDun,F.OctoberCaddis,F.PerdigonOlive,F.Slumpbuster],[F.BwoEmerger,F.Blowtorch,F.ArticulatedLeech],[F.ZebraMidge,F.Frenchie,F.WoollyBugger],[F.ZebraMidge,F.PerdigonRed]],
      'Strawberry River':[[F.MidgeLarva,F.WoollyBugger],[F.ZebraMidge,F.Frenchie,F.Slumpbuster],[F.BwoNymph,{t:'e',n:"Jig Hare's Ear"},{t:'s',n:"Pat's Rubber Legs"}],[F.SkwalaStone,F.BwoRs2,F.Perdigon,F.ConeheadSculpin],[F.Salmonfly,F.CaddisLarva,{t:'e',n:"Walt's Worm"}],[F.Stimulator,F.Pmd,F.Blowtorch,F.ArticulatedLeech],[F.PmdDry,F.YellowSally,F.RainbowWarrior,{t:'n',n:'Hopper (Dry)'}],[F.ChubbyChernobyl,F.Trico,F.Frenchie,F.CircusPeanut],[F.MahoganyDun,{t:'e',n:"Jig Hare's Ear"},F.Slumpbuster],[F.BwoEmerger,F.Blowtorch,F.WoollyBugger],[F.ZebraMidge,F.PerdigonRed],[F.MidgeLarva,F.WoollyBugger]],
  ...
  ID:{
    ...
    data:{
      "South Fork Snake":[[F.WoollyBugger,F.ZebraMidge,F.Perdigon],[F.MidgeLarva,F.Frenchie,F.Slumpbuster],[F.SkwalaNymph,F.BwoNymph,{t:'e',n:"Jig Hare's Ear"},F.ConeheadSculpin],[F.SkwalaDry,F.BwoRs2,F.Blowtorch,F.CircusPeanut],[F.SalmonflyNymph,F.CaddisLarva,{t:'e',n:"Walt's Worm"},F.ArticulatedLeech],[F.SalmonflyDry,F.Stimulator,F.PmdNymph,F.PerdigonOlive],[F.PmdDry,F.YellowSally,F.RainbowWarrior,F.Hopper],[F.ChubbyChernobyl,F.Trico,F.Frenchie,F.DrunkDisorderly],[{t:'n',n:'October Caddis'},F.CaddisPupa,{t:'e',n:"Jig Hare's Ear"},F.CircusPeanut],[F.BwoEmerger,F.Blowtorch,F.Slumpbuster,F.OctoberCaddisDry],[F.ZebraMidge,F.PerdigonBlack,F.WoollyBugger],[F.MidgeLarva,F.WoollyBugger,F.Frenchie]],
      "Henry's Fork":[[F.ZebraMidge,F.RainbowWarrior,F.WoollyBugger],[F.MidgeCluster,F.Frenchie,F.Slumpbuster],[F.BwoNymph,F.SkwalaNymph,{t:'e',n:"Jig Hare's Ear"}],[F.SkwalaDry,F.CallibaetisNymph,F.Blowtorch,F.ConeheadSculpin],[F.Salmonfly,F.PmdNymph,{t:'e',n:"Walt's Worm"},F.CircusPeanut],[F.Stimulator,F.PmdDry,F.CallibaetisDry,F.Perdigon],[F.PmdSparkleDun,F.YellowSally,F.RainbowWarrior,F.Trico],[F.TricoDry,F.ChubbyChernobyl,F.Callibaetis,F.ArticulatedLeech],[{t:'n',n:'October Caddis'},F.Frenchie,F.DrunkDisorderly,F.BrownDrake],[F.BwoEmerger,F.Blowtorch,F.WoollyBuggerOlive],[F.ZebraMidge,F.PerdigonRed,F.Slumpbuster],[F.MidgeLarva,{t:'e',n:"Jig Hare's Ear"},F.WoollyBugger]],
      'Duchesne River':[[F.MidgeLarva,F.WoollyBugger],[F.ZebraMidge,F.Frenchie,F.Slumpbuster],[F.BwoNymph,F.SkwalaNymph,F.Perdigon],[F.SkwalaDry,F.PheasantTail,F.Blowtorch,F.ConeheadSculpin],[F.GoldenStone,F.CaddisLarva,{t:'e',n:'Elk Hair Caddis'},F.CircusPeanut],[F.PmdNymph,F.Stimulator,{t:'e',n:"Walt's Worm"},F.ArticulatedLeech],[F.PmdDry,F.YellowSally,F.RainbowWarrior,F.Hopper],[F.ChubbyChernobyl,F.Trico,F.Frenchie,F.WoollyBugger],[F.MahoganyDun,F.OctoberCaddis,F.PerdigonOlive,F.Slumpbuster],[F.BwoEmerger,F.Blowtorch,F.ArticulatedLeech],[F.ZebraMidge,F.Frenchie,F.WoollyBugger],[F.MidgeLarva,F.Slumpbuster]],
      'Diamond Fork':[[F.MidgeLarva,F.WoollyBugger],[F.ZebraMidge,F.Frenchie],[F.BwoNymph,F.Rs2,F.Slumpbuster],[F.BwoDry,F.PheasantTail,F.Blowtorch,F.ConeheadSculpin],[F.CaddisLarva,{t:'e',n:'Elk Hair Caddis'},F.CircusPeanut],[F.PmdNymph,F.CaddisDryFly,{t:'e',n:"Walt's Worm"},F.ArticulatedLeech],[F.PmdSparkleDun,F.YellowSally,F.RainbowWarrior,F.AntDry],[F.HopperDry,F.Trico,F.PerdigonOlive,F.WoollyBugger],[F.MahoganyDun,F.OctoberCaddis,F.Frenchie,F.Slumpbuster],[F.BwoEmerger,F.Blowtorch,F.ArticulatedLeech],[F.ZebraMidge,F.Rs2,F.WoollyBugger],[F.MidgeLarva,F.Frenchie]],
      'Sixth Water Creek':[[F.MidgeLarva,F.WoollyBugger],[F.ZebraMidge,F.Frenchie],[F.BwoNymph,F.Rs2,F.Slumpbuster],[F.BwoDry,F.PheasantTail,F.Perdigon],[{t:'n',n:'Caddis Pupa'},{t:'e',n:'Elk Hair Caddis'},F.CircusPeanut],[F.Stimulator,F.CaddisLarva,{t:'e',n:"Walt's Worm"}],[{t:'s',n:'PMD (Dry)'},{t:'n',n:'Yellow Sally'},F.RainbowWarrior,{t:'s',n:'Ant (Dry)'}],[F.ChubbyChernobyl,F.Trico,F.Frenchie,{t:'s',n:'Hopper'}],[F.MahoganyDun,F.OctoberCaddis,F.PerdigonOlive],[F.BwoEmerger,F.Rs2,F.WoollyBugger],[F.ZebraMidge,F.Frenchie],[F.MidgeLarva,F.Slumpbuster]],
      'Teton River':[[F.WoollyBugger,F.MidgeLarva],[F.ZebraMidge,F.Perdigon],[{t:'s',n:"Pat's Rubber Legs"},F.BwoNymph,F.Frenchie],[F.SkwalaDry,F.PheasantTail,F.Slumpbuster],[F.SalmonflyNymph,F.ElkHairCaddis,{t:'e',n:"Walt's Worm"}],[F.Stimulator,F.Pmd,F.CircusPeanut,{t:'e',n:"Jig Hare's Ear"}],[F.PmdDry,F.YellowSally,F.Blowtorch,F.Hopper],[F.ChubbyChernobyl,F.Trico,F.ArticulatedLeech],[{t:'n',n:'October Caddis'},F.Frenchie,F.DrunkDisorderly],[F.BwoEmerger,F.RainbowWarrior,F.WoollyBugger],[F.ZebraMidge,F.Slumpbuster],[F.MidgeLarva,F.WoollyBugger]],
      'Boise River':[[F.ZebraMidge,F.Frenchie,F.WoollyBugger],[F.MidgeLarva,F.Perdigon,F.Slumpbuster],[F.SkwalaNymph,F.BwoNymph,{t:'e',n:"Jig Hare's Ear"}],[F.SkwalaDry,{t:'n',n:'Caddis Pupa'},F.Blowtorch,F.ConeheadSculpin],[F.Salmonfly,F.SoftHackle,{t:'e',n:"Walt's Worm"}],[F.Stimulator,F.PmdNymph,F.CircusPeanut],[F.PmdDry,F.YellowSally,F.RainbowWarrior,F.Hopper],[F.ChubbyChernobyl,F.Trico,F.DrunkDisorderly],[{t:'n',n:'October Caddis'},F.Frenchie,F.Slumpbuster],[F.BwoEmerger,F.Blowtorch,F.ArticulatedLeech],[F.ZebraMidge,{t:'e',n:"Jig Hare's Ear"}],[F.MidgeLarva,F.WoollyBugger]],
      'Big Wood River':[[F.WoollyBugger,F.ZebraMidge],[F.MidgeLarva,F.Frenchie],[{t:'s',n:"Pat's Rubber Legs"},F.BwoNymph,F.Perdigon],[F.SkwalaStone,F.CaddisLarva,F.Slumpbuster],[F.SalmonflyNymph,F.ElkHairCaddis,{t:'e',n:"Jig Hare's Ear"}],[F.Stimulator,F.Pmd,{t:'e',n:"Walt's Worm"},F.CircusPeanut],[F.PmdDry,F.YellowSally,F.Blowtorch,F.Hopper],[F.ChubbyChernobyl,F.Trico,F.ArticulatedLeech],[{t:'n',n:'October Caddis'},F.RainbowWarrior,F.DrunkDisorderly],[F.BwoEmerger,F.Frenchie,F.WoollyBugger],[F.ZebraMidge,F.PerdigonRed],[F.MidgeLarva,F.WoollyBugger]],
      'Silver Creek':[[F.MidgeLarvaTiny,F.Perdigon20],[F.ZebraMidge20,F.RainbowWarrior],[F.BwoNymphTiny,F.Frenchie18,F.PheasantTail18],[F.BwoRs2,F.CallibaetisNymph,F.OliveSculpin],[F.PmdNymph,F.CaddisLarva,{t:'e',n:"Jig Hare's Ear"}],[F.PmdSparkleDun,F.CallibaetisDry,{t:'e',n:"Walt's Worm"}],[F.PmdTinyDry,F.Trico,F.Blowtorch20,{t:'n',n:'Damsel Nymph'}],[F.TricoDry,F.Callibaetis,F.WoollyBuggerSmall],[{t:'n',n:'October Caddis'},F.MahoganyDun,F.Frenchie],[F.BwoEmerger,F.RainbowWarrior,F.SlumpbusterSmall],[F.ZebraMidge,F.PerdigonBlack],[F.MidgeLarva,{t:'e',n:"Jig Hare's Ear"}]],
    }
  },
  WY:{
    rivers:['Green River','Snake River (WY)','Hoback River','North Platte','Shoshone River','Yellowstone River (WY)'],
    data:{
      'Green River':[[F.WoollyBugger,F.MidgeLarva,F.PerdigonRed],[F.ZebraMidge,F.Frenchie,F.Slumpbuster],[{t:'s',n:"Pat's Rubber Legs"},F.BwoNymph,{t:'e',n:"Jig Hare's Ear"}],[F.SkwalaStone,F.BwoRs2,F.Blowtorch,F.ConeheadSculpin],[F.SalmonflyNymph,F.CaddisLarva,{t:'e',n:"Walt's Worm"},F.ArticulatedLeech],[F.SalmonflyDry,F.Stimulator,F.PmdNymph,F.PerdigonOlive],[F.PmdSparkleDun,F.YellowSally,F.RainbowWarrior,F.Hopper],[F.ChubbyChernobyl,F.Trico,F.Frenchie,F.CircusPeanut],[{t:'n',n:'October Caddis'},{t:'e',n:"Jig Hare's Ear"},F.DrunkDisorderly],[F.BwoEmerger,F.Blowtorch,F.WoollyBuggerOlive],[F.ZebraMidge,F.PerdigonBlack,F.Slumpbuster],[F.MidgeLarva,F.WoollyBugger,F.RainbowWarrior]],
      'Snake River (WY)':[[F.WoollyBugger,F.ZebraMidge],[F.MidgeLarva,F.Frenchie],[{t:'s',n:"Pat's Rubber Legs"},F.PheasantTail,{t:'e',n:"Jig Hare's Ear"}],[F.SkwalaNymph,F.BwoEmerger,F.Slumpbuster],[F.SalmonflyNymph,{t:'n',n:'Caddis Pupa'},F.Perdigon],[F.Stimulator,F.PmdNymph,F.CircusPeanut,{t:'e',n:"Walt's Worm"}],[F.PmdDry,F.YellowSally,F.Blowtorch,F.HopperAttractor],[F.ChubbyChernobyl,F.Trico,F.ArticulatedLeech],[{t:'n',n:'October Caddis'},F.Frenchie,F.DrunkDisorderly],[F.BwoNymph,F.RainbowWarrior,F.WoollyBugger],[F.ZebraMidge,F.Slumpbuster],[F.MidgeLarva,F.WoollyBugger]],
      'Hoback River':[[F.WoollyBugger,F.MidgeLarva],[F.ZebraMidge,F.Perdigon],[{t:'s',n:"Pat's Rubber Legs"},F.BwoNymph],[F.SkwalaStone,F.PheasantTail,F.ConeheadSculpin],[F.Salmonfly,F.ElkHairCaddis,{t:'e',n:"Jig Hare's Ear"}],[F.Stimulator,F.Pmd,F.Frenchie,F.Slumpbuster],[F.PmdDry,F.YellowSally,F.Blowtorch,F.Hopper],[F.ChubbyChernobyl,F.Trico,F.CircusPeanut],[{t:'n',n:'October Caddis'},{t:'e',n:"Walt's Worm"},F.ArticulatedLeech],[F.BwoEmerger,F.RainbowWarrior,F.WoollyBugger],[F.ZebraMidge,F.Frenchie],[F.MidgeLarva,F.WoollyBugger]],
      'North Platte':[[F.MidgeLarva,F.ZebraMidgeJig,F.WoollyBugger],[F.ZebraMidge,F.Perdigon,F.Slumpbuster],[F.BwoNymph,{t:'s',n:"Pat's Rubber Legs"},F.Frenchie],[F.SkwalaStone,F.PheasantTail,F.ConeheadSculpin],[F.SalmonflyNymph,F.CaddisLarva,{t:'e',n:"Jig Hare's Ear"}],[F.Stimulator,F.PmdNymph,F.Blowtorch,F.CircusPeanut],[F.PmdSparkleDun,F.YellowSally,F.RainbowWarrior,F.Hopper],[F.ChubbyChernobyl,F.Trico,{t:'e',n:"Walt's Worm"},F.DrunkDisorderly],[{t:'n',n:'October Caddis'},F.Frenchie,F.ArticulatedLeech],[F.BwoEmerger,F.Blowtorch,F.Slumpbuster],[F.ZebraMidge,F.PerdigonBlack],[F.MidgeLarva,F.WoollyBugger]],
      ...
      'Yellowstone River (WY)':[[F.WoollyBuggerLarge,F.MidgeLarva],[F.ZebraMidge,F.PerdigonRed],[{t:'s',n:"Pat's Rubber Legs"},F.BwoNymph,{t:'e',n:"Jig Hare's Ear"}],[F.SkwalaNymph,F.CaddisLarva,F.ConeheadSculpin],[F.SalmonflyNymph,F.ElkHairCaddis,F.Frenchie],[F.SalmonflyDry,F.Pmd,{t:'e',n:"Walt's Worm"},F.CircusPeanut],[F.PmdSparkleDun,F.YellowSally,F.Blowtorch,F.Hopper],[F.ChubbyChernobyl,F.Trico,F.DrunkDisorderly],[{t:'n',n:'October Caddis'},F.RainbowWarrior,F.ArticulatedLeech],[F.BwoEmerger,F.Frenchie,F.Slumpbuster],[F.ZebraMidge,F.PerdigonBlack,F.WoollyBugger],[F.MidgeLarva,F.WoollyBuggerLarge]],
    }
  },
  MT:{
    rivers:['Madison River','Bighorn River','Gallatin River','Missouri River','Yellowstone River (MT)','Clark Fork'],
    data:{
      'Madison River':[[F.ZebraMidge,F.RainbowWarrior,F.WoollyBugger],[F.MidgeCluster,F.PerdigonRed,F.Slumpbuster],[F.SkwalaNymph,F.BwoNymph,{t:'e',n:"Jig Hare's Ear"}],[F.SkwalaDry,F.BwoRs2,F.Blowtorch,F.ConeheadSculpin],[F.SalmonflyNymph,F.CaddisLarva,{t:'e',n:"Walt's Worm"},F.ArticulatedLeech],[F.SalmonflyDry,F.Stimulator,F.PmdNymph,F.PerdigonOlive],[F.PmdSparkleDun,F.YellowSally,F.RainbowWarrior,F.Hopper],[F.ChubbyChernobyl,F.Trico,F.Frenchie,F.CircusPeanut],[{t:'n',n:'October Caddis'},{t:'e',n:"Jig Hare's Ear"},F.DrunkDisorderly],[F.BwoEmerger,F.Blowtorch,F.WoollyBuggerOlive],[F.ZebraMidge,F.PerdigonBlack,F.Slumpbuster],[F.MidgeLarva,F.WoollyBugger,F.RainbowWarrior]],
      'Bighorn River':[[F.ZebraMidge,F.Frenchie,F.WoollyBugger],[F.MidgeLarva,F.RainbowWarrior,F.Slumpbuster],[F.BwoNymph,F.Perdigon,F.SanJuanWorm],[F.BwoRs2,F.Blowtorch,F.PheasantTail,F.ConeheadSculpin],[F.PmdNymph,F.CaddisLarva,{t:'e',n:"Jig Hare's Ear"},F.ArticulatedLeech],[F.PmdDry,F.CaddisDry,{t:'e',n:"Walt's Worm"},F.CircusPeanut],[F.TricoDry,F.PmdSparkleDun,F.RainbowWarrior,F.SowBug],[F.TricoNymph,F.Scud,F.Frenchie,F.DrunkDisorderly],[{t:'n',n:'October Caddis'},F.Blowtorch,F.WoollyBugger],[F.BwoEmerger,F.PerdigonBlack,F.Slumpbuster],[F.ZebraMidge,{t:'e',n:"Jig Hare's Ear"},F.ArticulatedLeech],[F.ZebraMidge,F.Frenchie,F.WoollyBugger]],
      'Gallatin River':[[F.WoollyBugger,F.MidgeLarva],[F.ZebraMidge,F.Frenchie],[F.SkwalaNymph,F.BwoNymph,F.Perdigon],[F.SkwalaDry,{t:'n',n:'Caddis Pupa'},F.Slumpbuster],[F.Salmonfly,F.ElkHairCaddis,{t:'e',n:"Jig Hare's Ear"}],[F.Stimulator,F.Pmd,{t:'e',n:"Walt's Worm"},F.CircusPeanut],[F.PmdDry,F.YellowSally,F.Blowtorch,F.Hopper],[F.ChubbyChernobyl,F.Trico,F.ArticulatedLeech],[{t:'n',n:'October Caddis'},F.RainbowWarrior,F.DrunkDisorderly],[F.BwoEmerger,F.Frenchie,F.WoollyBugger],[F.ZebraMidge,F.PerdigonRed],[F.WoollyBugger,F.MidgeLarva]],
      'Missouri River':[[F.ZebraMidge,F.RainbowWarrior,F.WoollyBugger],[F.MidgeLarva,F.PerdigonRed,F.Slumpbuster],[F.BwoNymph,F.Frenchie,F.SanJuanWorm],[F.BwoRs2,F.Blowtorch,F.PheasantTail,F.ConeheadSculpin],[F.PmdNymph,F.CaddisLarva,{t:'e',n:"Jig Hare's Ear"}],[F.PmdDry,F.ElkHairCaddis,{t:'e',n:"Walt's Worm"},F.CircusPeanut],[F.TricoDry,F.PmdSparkleDun,F.RainbowWarrior,F.Hopper],[F.TricoNymph,F.Scud,F.Frenchie,F.DrunkDisorderly],[{t:'n',n:'October Caddis'},F.Blowtorch,F.ArticulatedLeech],[F.BwoEmerger,F.PerdigonBlack,F.Slumpbuster],[F.ZebraMidge,{t:'e',n:"Jig Hare's Ear"}],[F.ZebraMidge,F.WoollyBugger,F.RainbowWarrior]],
      'Yellowstone River (MT)':[[F.WoollyBugger,F.MidgeLarva],[F.ZebraMidge,F.Frenchie],[{t:'s',n:"Pat's Rubber Legs"},F.BwoNymph,F.Perdigon],[F.SkwalaStone,F.PheasantTail,F.Slumpbuster],[F.SalmonflyNymph,F.CaddisLarva,{t:'e',n:"Jig Hare's Ear"}],[F.SalmonflyDry,F.Pmd,{t:'e',n:"Walt's Worm"},F.CircusPeanut],[F.PmdSparkleDun,F.YellowSally,F.Blowtorch,F.Hopper],[F.ChubbyChernobyl,F.Trico,F.DrunkDisorderly],[{t:'n',n:'October Caddis'},F.RainbowWarrior,F.ArticulatedLeech],[F.BwoEmerger,F.Frenchie,F.Slumpbuster],[F.ZebraMidge,F.PerdigonBlack,F.WoollyBugger],[F.MidgeLarva,F.WoollyBugger]],
      'Clark Fork':[[F.WoollyBugger,F.MidgeLarva],[F.ZebraMidge,F.Perdigon],[{t:'s',n:"Pat's Rubber Legs"},F.BwoNymph,F.Frenchie],[F.SkwalaDry,{t:'n',n:'Caddis Pupa'},F.ConeheadSculpin],[F.Salmonfly,F.ElkHairCaddis,{t:'e',n:"Jig Hare's Ear"}],[F.Stimulator,F.Pmd,{t:'e',n:"Walt's Worm"},F.CircusPeanut],[F.PmdDry,F.YellowSally,F.Blowtorch,F.Hopper],[F.ChubbyChernobyl,F.Trico,F.ArticulatedLeech],[{t:'n',n:'October Caddis'},F.RainbowWarrior,F.DrunkDisorderly],[F.BwoEmerger,F.Frenchie,F.WoollyBugger],[F.ZebraMidge,F.PerdigonRed],[F.WoollyBugger,F.MidgeLarva]],
    }
  },
  CO:{
    rivers:['Arkansas River','South Platte River','Frying Pan River','Blue River','Roaring Fork','Cache la Poudre'],
    data:{
      'Arkansas River':[[F.ZebraMidge,F.Perdigon,F.WoollyBugger],[F.MidgeLarva,F.Frenchie,F.Slumpbuster],[F.BwoNymph,{t:'e',n:"Jig Hare's Ear"},F.SanJuanWorm],[F.PheasantTail,F.Blowtorch,F.ConeheadSculpin],[F.SalmonflyNymph,F.CaddisLarva,{t:'e',n:"Walt's Worm"}],[F.Stimulator,F.Pmd,F.PerdigonOlive,F.CircusPeanut],[F.PmdDry,F.YellowSally,F.RainbowWarrior,F.Hopper],[F.ChubbyChernobyl,F.Trico,F.Frenchie,F.ArticulatedLeech],[{t:'n',n:'October Caddis'},{t:'e',n:"Jig Hare's Ear"},F.DrunkDisorderly],[F.BwoEmerger,F.Blowtorch,F.Slumpbuster],[F.ZebraMidge,F.PerdigonBlack],[F.MidgeLarva,F.WoollyBugger]],
      'South Platte River':[[F.ZebraMidge,F.RainbowWarrior,F.WoollyBugger],[F.MidgeLarva,F.PerdigonRed,F.Slumpbuster],[F.BwoNymph,F.Frenchie,{t:'n',n:'RS2'}],[F.BwoRs2,F.Blowtorch,F.PheasantTail,F.ConeheadSculpin],[F.PmdNymph,F.CaddisLarva,{t:'e',n:"Jig Hare's Ear"}],[F.PmdDry,F.ElkHairCaddis,{t:'e',n:"Walt's Worm"},F.CircusPeanut],[F.PmdSparkleDun,F.YellowSally,F.RainbowWarrior,F.Hopper],[F.TricoDry,F.Scud,F.Frenchie,F.DrunkDisorderly],[{t:'n',n:'October Caddis'},F.Blowtorch,F.ArticulatedLeech],[F.BwoEmerger,F.PerdigonBlack,F.Slumpbuster],[F.ZebraMidge,{t:'e',n:"Jig Hare's Ear"}],[F.ZebraMidge,F.WoollyBugger]],
      'Frying Pan River':[[F.MidgeLarva,F.Perdigon20,F.WoollyBugger],[F.ZebraMidge,F.RainbowWarrior22],[F.BwoNymph,F.Frenchie18,{t:'n',n:'RS2'}],[F.BwoRs2,F.Blowtorch,F.MidgePupa],[F.PmdNymph,F.Scud,{t:'e',n:"Jig Hare's Ear"}],[F.PmdDry,{t:'n',n:'Caddis Dry'},{t:'e',n:"Walt's Worm"},F.Slumpbuster],[F.PmdSparkleDun,F.Trico,F.RainbowWarrior,F.Hoppers],[F.TricoDry,F.Scud,F.Frenchie,F.WoollyBugger],[{t:'n',n:'October Caddis'},F.Blowtorch,F.CircusPeanut],[F.BwoEmerger,F.Perdigon,F.ArticulatedLeech],[F.ZebraMidge,{t:'e',n:"Jig Hare's Ear"}],[F.MidgeLarva,F.WoollyBugger]],
      ...
      'Roaring Fork':[[F.WoollyBugger,F.MidgeLarva],[F.ZebraMidge,F.Perdigon],[F.SkwalaNymph,F.BwoNymph,F.Frenchie],[F.SkwalaDry,F.PheasantTail,F.Slumpbuster],[F.Salmonfly,{t:'n',n:'Caddis Pupa'},{t:'e',n:"Jig Hare's Ear"}],[F.Stimulator,F.Pmd,{t:'e',n:"Walt's Worm"},F.CircusPeanut],[F.PmdDry,F.YellowSally,F.Blowtorch,F.Hopper],[F.ChubbyChernobyl,F.Trico,F.ArticulatedLeech],[{t:'n',n:'October Caddis'},F.RainbowWarrior,F.DrunkDisorderly],[F.BwoEmerger,F.Frenchie,F.WoollyBugger],[F.ZebraMidge,F.PerdigonBlack],[F.WoollyBugger,F.MidgeLarva]],
      'Cache la Poudre':[[F.WoollyBugger,F.MidgeLarva],[F.ZebraMidge,F.Frenchie],[F.SkwalaNymph,F.BwoNymph,F.Perdigon],[F.SkwalaDry,F.CaddisLarva,F.ConeheadSculpin],[F.Salmonfly,F.ElkHairCaddis,{t:'e',n:"Jig Hare's Ear"}],[F.Stimulator,F.Pmd,{t:'e',n:"Walt's Worm"},F.Slumpbuster],[F.PmdDry,F.YellowSally,F.RainbowWarrior,F.Hopper],[F.ChubbyChernobyl,F.Trico,F.CircusPeanut],[{t:'n',n:'October Caddis'},F.Blowtorch,F.ArticulatedLeech],[F.BwoEmerger,F.Frenchie,F.DrunkDisorderly],[F.ZebraMidge,F.PerdigonRed],[F.WoollyBugger,F.MidgeLarva]],
    }
  },
  OR:{
    rivers:['Deschutes River','Sandy River','Rogue River','McKenzie River','John Day River','Williamson River'],
    data:{
      'Deschutes River':[[F.WoollyBugger,F.MidgeLarva,F.Perdigon],[F.ZebraMidge,F.Frenchie,F.Slumpbuster],[F.SkwalaNymph,F.BwoNymph,{t:'e',n:"Jig Hare's Ear"}],[F.SkwalaDry,F.PheasantTail,F.ConeheadSculpin],[F.SalmonflyNymph,F.CaddisLarva,{t:'e',n:"Walt's Worm"},F.ArticulatedLeech],[F.SalmonflyDry,F.Stimulator,F.Pmd,F.PerdigonOlive],[F.PmdSparkleDun,F.YellowSally,F.RainbowWarrior,F.Hopper],[F.ChubbyChernobyl,F.Trico,F.Frenchie,F.CircusPeanut],[F.OctoberCaddisBig,{t:'e',n:"Jig Hare's Ear"},F.DrunkDisorderly],[F.BwoEmerger,F.Blowtorch,F.Slumpbuster],[F.ZebraMidge,F.PerdigonBlack,F.WoollyBugger],[F.MidgeLarva,F.WoollyBugger]],
      'Sandy River':[[F.PinkWorm,F.WoollyBugger],[F.EstazEgg,F.Slumpbuster,F.StoneflyNymph],[F.StoneflyNymphDark,F.BunnyLeech,F.CaddisLarva],[F.SkwalaDry,F.CircusPeanut,F.BwoNymph],[F.SalmonflyNymph,F.ElkHairCaddis,F.ArticulatedLeech],[F.Stimulator,F.SoftHackle,F.ConeheadSculpin],[F.PmdDry,F.YellowSally,F.RainbowWarrior,F.Hopper],[F.ChubbyChernobyl,F.Trico,F.WoollyBugger],[{t:'n',n:'October Caddis (Dry)'},F.Frenchie,F.DrunkDisorderly],[F.BwoEmerger,F.PinkWorm,F.Slumpbuster],[F.PinkEgg,F.BunnyLeech],[F.PinkWorm,F.WoollyBugger]],
      'Rogue River':[[F.WoollyBugger,F.StoneflyNymph],[F.CaddisLarva,F.Slumpbuster,F.Perdigon],[F.SkwalaNymph,F.BwoNymph,F.BunnyLeech],[F.SkwalaDry,F.PheasantTail,F.CircusPeanut],[F.Salmonfly,F.ElkHairCaddis,{t:'e',n:"Jig Hare's Ear"}],[F.Stimulator,F.Pmd,F.ConeheadSculpin],[F.PmdDry,F.YellowSally,F.Blowtorch,F.Hopper],[F.ChubbyChernobyl,F.SoftHackle,F.ArticulatedLeech],[{t:'n',n:'October Caddis'},F.RainbowWarrior,F.DrunkDisorderly],[F.BwoEmerger,F.Frenchie,F.WoollyBugger],[F.StoneflyNymph,F.BunnyLeech],[F.WoollyBugger,F.CaddisLarva]],
      'McKenzie River':[[F.WoollyBugger,F.MidgeLarva],[F.CaddisLarva,F.Frenchie],[F.SkwalaNymph,F.BwoNymph,F.Perdigon],[F.SkwalaDry,F.ElkHairCaddis,F.Slumpbuster],[F.Salmonfly,F.SoftHackle,{t:'e',n:"Jig Hare's Ear"}],[F.Stimulator,F.Pmd,{t:'e',n:"Walt's Worm"},F.CircusPeanut],[F.PmdDry,F.YellowSally,F.Blowtorch,F.Hopper],[F.ChubbyChernobyl,{t:'n',n:'Caddis Pupa'},F.ArticulatedLeech],[{t:'n',n:'October Caddis'},F.RainbowWarrior,F.DrunkDisorderly],[F.BwoEmerger,F.Frenchie,F.WoollyBugger],[F.StoneflyNymph,F.PerdigonRed],[F.WoollyBugger,F.MidgeLarva]],
      'John Day River':[[F.WoollyBugger,F.MidgeLarva],[F.ZebraMidge,F.Frenchie],[{t:'s',n:'Stonefly Nymph'},F.BwoNymph,F.Perdigon],[F.SkwalaDry,F.CaddisLarva,F.Slumpbuster],[F.Salmonfly,F.ElkHairCaddis,{t:'e',n:"Jig Hare's Ear"}],[F.Stimulator,F.Pmd,F.CircusPeanut],[F.PmdDry,F.YellowSally,F.Blowtorch,F.Hopper],[F.ChubbyChernobyl,F.Trico,F.ArticulatedLeech],[{t:'n',n:'October Caddis'},F.RainbowWarrior,F.DrunkDisorderly],[F.BwoEmerger,F.Frenchie,F.WoollyBugger],[F.ZebraMidge,F.PerdigonBlack],[F.WoollyBugger,F.MidgeLarva]],
      'Williamson River':[[F.MidgeLarva,F.RainbowWarrior,F.WoollyBugger],[F.MidgeCluster,F.Frenchie],[F.BwoNymph,F.Perdigon,F.CallibaetisNymph],[F.CallibaetisDry,F.Blowtorch,F.PheasantTail],[F.PmdNymph,F.CaddisLarva,{t:'e',n:"Jig Hare's Ear"}],[F.PmdDry,F.CallibaetisDry,{t:'e',n:"Walt's Worm"},F.Slumpbuster],[F.TricoDry,{t:'n',n:'Damsel Nymph'},F.RainbowWarrior,F.ArticulatedLeech],[F.Callibaetis,F.TricoNymph,F.Frenchie,F.WoollyBugger],[{t:'n',n:'October Caddis'},F.Blowtorch,F.DrunkDisorderly],[F.BwoEmerger,F.PerdigonBlack],[F.MidgeLarva,{t:'e',n:"Jig Hare's Ear"}],[F.MidgeCluster,F.WoollyBugger]],
    }
  },
  WA:{
    ...
    data:{
      ...
      'Methow River':[[F.WoollyBugger,F.MidgeLarva],[F.ZebraMidge,F.Frenchie],[F.SkwalaNymph,F.BwoNymph,F.Perdigon],[F.SkwalaDry,F.PheasantTail,F.Slumpbuster],[F.Salmonfly,{t:'n',n:'Caddis Pupa'},{t:'e',n:"Jig Hare's Ear"}],[F.Stimulator,F.Pmd,{t:'e',n:"Walt's Worm"},F.CircusPeanut],[F.PmdDry,F.YellowSally,F.Blowtorch,F.Hopper],[F.ChubbyChernobyl,F.Trico,F.ArticulatedLeech],[{t:'n',n:'October Caddis'},F.RainbowWarrior,F.DrunkDisorderly],[F.BwoEmerger,F.Frenchie,F.WoollyBugger],[F.ZebraMidge,F.PerdigonRed],[F.WoollyBugger,F.MidgeLarva]],
      'Skagit River':[[F.PinkWorm,F.WoollyBugger,F.StoneflyNymph],[F.EstazEgg,F.BunnyLeech,F.CaddisLarva],[{t:'s',n:'Stonefly Nymph'},F.CircusPeanut,F.BwoNymph],[F.SkwalaDry,F.ArticulatedLeech,F.PheasantTail],[F.SalmonflyNymph,F.ElkHairCaddis,F.Slumpbuster],[F.Stimulator,F.SoftHackle,F.ConeheadSculpin],[F.PmdDry,F.YellowSally,F.Frenchie,F.Hopper],[F.ChubbyChernobyl,{t:'n',n:'Caddis Pupa'},F.DrunkDisorderly],[{t:'n',n:'October Caddis'},F.RainbowWarrior,F.WoollyBugger],[F.BwoEmerger,F.PinkWorm,F.Slumpbuster],[F.EggPattern,F.BunnyLeech],[F.PinkWorm,F.WoollyBugger]],
      'Klickitat River':[[F.WoollyBugger,F.StoneflyNymph],[F.CaddisLarva,F.Slumpbuster],[F.StoneflyNymphDark,F.BwoNymph,F.Frenchie],[F.SkwalaDry,F.PheasantTail,F.CircusPeanut],[F.Salmonfly,F.ElkHairCaddis,{t:'e',n:"Jig Hare's Ear"}],[F.Stimulator,F.SoftHackle,F.ConeheadSculpin],[F.Hopper,F.YellowSally,F.Blowtorch,F.PmdDry],[F.ChubbyChernobyl,{t:'n',n:'Caddis Pupa'},F.ArticulatedLeech],[F.OctoberCaddisBig,F.RainbowWarrior,F.DrunkDisorderly],[F.BwoEmerger,F.Perdigon,F.WoollyBugger],[F.EggPattern,F.StoneflyNymph],[F.WoollyBugger,F.MidgeLarva]],
      'Wenatchee River':[[F.WoollyBugger,F.MidgeLarva],[F.ZebraMidge,F.Frenchie],[F.SkwalaNymph,F.BwoNymph,F.Perdigon],[F.SkwalaDry,F.CaddisLarva,F.Slumpbuster],[F.Salmonfly,F.ElkHairCaddis,{t:'e',n:"Jig Hare's Ear"}],[F.Stimulator,F.Pmd,{t:'e',n:"Walt's Worm"},F.CircusPeanut],[F.PmdDry,F.YellowSally,F.Blowtorch,F.Hopper],[F.ChubbyChernobyl,F.Trico,F.ArticulatedLeech],[{t:'n',n:'October Caddis'},F.RainbowWarrior,F.DrunkDisorderly],[F.BwoEmerger,F.Frenchie,F.WoollyBugger],[F.ZebraMidge,F.PerdigonBlack],[F.WoollyBugger,F.MidgeLarva]],
                ...
                <>
                  ...
                  {(() => {
                    const insectQ = info.type && thisStage
                      ? INSECT_SEARCH[info.type + '|' + thisStage.stage] || INSECT_SEARCH[info.type]
                      : INSECT_SEARCH[info.type];
                    const flyQ = FLY_SEARCH[key] || (flyName + ' fly pattern fishing');
                    return (
                      <div style={{ marginBottom:'1.4rem' }}>
                        ...
                        <div className="fly-compare-row" style={{ display:'flex', gap:'1rem', alignItems:'flex-start' }}>
                          <div className="fly-compare-col" style={{ flex:1, textAlign:'center', minWidth:0 }}>
                            <FlyImage
                              query={insectQ}
                              type={info.type}
                    ...
                    <div style={{ padding:'.8rem 1rem' }}>
                      ...
                      {(() => {
                        const famType = { midge:'midge', bwo:'mayfly', pmd:'mayfly',
                          ...
                          streamer_family:'streamer' }[famKey] || 'mayfly';
                        const insectQ = INSECT_SEARCH[famType + '|' + stage.stage]
                          || INSECT_SEARCH[famType];
                        return insectQ ? (
                          <div className="fly-stage-row" style={{ display:'flex', gap:'1rem', alignItems:'flex-start', marginBottom:'.9rem' }}>
                            <FlyImage query={insectQ} type={famType} label={stage.stage} size={100} />
                            <div style={{ flex:1 }}>
                        ...
                        <div>
                          ...
                          <div style={{ display:'flex', gap:'.6rem', flexWrap:'wrap' }}>
                            {stage.patterns.map(p => {
                              ...
                              const flyQ = FLY_SEARCH[pKey] || (p + ' fly pattern fishing');
                              const isCurrent = p === key;
                              return (
                                <div key={p} style={{ textAlign:'center', opacity: isCurrent ? 1 : 0.75 }}>
                                  <div style={{ position:'relative' }}>
                                    <FlyImage query={flyQ} type={null} label="" size={56} />
                                    {isCurrent && (
