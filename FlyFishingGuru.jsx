...
const FLY_INFO = {
  ...
  'Trico':           { insect: 'Tricorythodes spp. (Trico Mayfly)', type: 'mayfly',
...
const INSECT_TAXON = {
  ...
  'stillwater|Nymph':               'Callibaetis|5',
  'stillwater|Adult Dun':           'Callibaetis|16',
  'stillwater|Spinner':             'Callibaetis|2',
  ...
  'euro_nymph|Nymph':               'Baetidae|5',
  'euro_nymph|Larva':               'Chironomidae|6',
  'euro_nymph':                     'Baetidae|5',
...
const FLY_FILES = {
  ...
  'Midge Pupa': 'medallion-midge-pupa',
  ...
  'Skwala Stone': 'fools-gold-skwala',
  'Skwala Nymph': 'fools-gold-skwala',
  'Salmonfly Nymph': 'fools-gold-skwala',
  'Salmonfly': 'stimulator-orange',
  'Stimulator': 'stimulator-orange',
  'Yellow Sally': 'henrys-fork-yellow-sally',
  'Stonefly Nymph': 'fools-gold-skwala',
  ...
  'Articulated Leech': 'woolly-bugger-black-beadhead',
  'Slumpbuster': 'woolly-bugger-black-beadhead',
  'Circus Peanut': 'woolly-bugger-black-beadhead',
  'Drunk & Disorderly': 'woolly-bugger-black-beadhead',
...
function FlyImage({ taxon, flyFile, type, label, size = 120 }) {
  ...
  useEffect(() => {
    ...
    if (taxon) {
      ...
      // FlyFishFood Shopify product JSON — direct CDN image, always a hand-tied fly photo
