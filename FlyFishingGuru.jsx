...
const H = {
  UT:{
    ...
    data:{
      ...
      'Weber River':[[{t:'n',n:'Zebra Midge'},{t:'r',n:'Woolly Bugger'}],[{t:'n',n:'Midge Larva'},{t:'e',n:'Frenchie'},{t:'r',n:'Slumpbuster'}],[{t:'n',n:'BWO Nymph'},{t:'s',n:'Skwala Nymph'},{t:'e',n:'Perdigon'}],[{t:'s',n:'Skwala (Dry)'},{t:'n',n:'BWO RS2'},{t:'e',n:'Blowtorch'},{t:'r',n:'Conehead Sculpin'}],[{t:'s',n:'Golden Stone'},{t:'n',n:'Caddis Larva'},{t:'e',n:'Elk Hair Caddis'},{t:'r',n:'Circus Peanut'}],[{t:'n',n:'PMD Nymph'},{t:'s',n:'Caddis (Dry)'},{t:'e',n:"Walt's Worm"},{t:'r',n:'Articulated Leech'}],[{t:'n',n:'PMD Sparkle Dun'},{t:'s',n:'Yellow Sally'},{t:'e',n:'Rainbow Warrior'},{t:'n',n:'Ant (Dry)'}],[{t:'s',n:'Hopper (Dry)'},{t:'n',n:'Trico'},{t:'e',n:'Frenchie'},{t:'r',n:'Woolly Bugger'}],[{t:'n',n:'Mahogany Dun'},{t:'s',n:'October Caddis'},{t:'e',n:'Perdigon (Olive)'},{t:'r',n:'Slumpbuster'}],[{t:'n',n:'BWO Emerger'},{t:'e',n:'Blowtorch'},{t:'r',n:'Articulated Leech'}],[{t:'n',n:'Zebra Midge'},{t:'e',n:'Frenchie'},{t:'r',n:'Woolly Bugger'}],[{t:'n',n:'Zebra Midge'},{t:'e',n:'Perdigon (Red)'}]],
  ...
  ID:{
    ...
    data:{
      ...
      'Duchesne River':[[{t:'n',n:'Midge Larva'},{t:'r',n:'Woolly Bugger'}],[{t:'n',n:'Zebra Midge'},{t:'e',n:'Frenchie'},{t:'r',n:'Slumpbuster'}],[{t:'n',n:'BWO Nymph'},{t:'s',n:'Skwala Nymph'},{t:'e',n:'Perdigon'}],[{t:'s',n:'Skwala (Dry)'},{t:'n',n:'Pheasant Tail'},{t:'e',n:'Blowtorch'},{t:'r',n:'Conehead Sculpin'}],[{t:'s',n:'Golden Stone'},{t:'n',n:'Caddis Larva'},{t:'e',n:'Elk Hair Caddis'},{t:'r',n:'Circus Peanut'}],[{t:'n',n:'PMD Nymph'},{t:'s',n:'Stimulator'},{t:'e',n:"Walt's Worm"},{t:'r',n:'Articulated Leech'}],[{t:'n',n:'PMD (Dry)'},{t:'s',n:'Yellow Sally'},{t:'e',n:'Rainbow Warrior'},{t:'n',n:'Hopper'}],[{t:'s',n:'Chubby Chernobyl'},{t:'n',n:'Trico'},{t:'e',n:'Frenchie'},{t:'r',n:'Woolly Bugger'}],[{t:'n',n:'Mahogany Dun'},{t:'s',n:'October Caddis'},{t:'e',n:'Perdigon (Olive)'},{t:'r',n:'Slumpbuster'}],[{t:'n',n:'BWO Emerger'},{t:'e',n:'Blowtorch'},{t:'r',n:'Articulated Leech'}],[{t:'n',n:'Zebra Midge'},{t:'e',n:'Frenchie'},{t:'r',n:'Woolly Bugger'}],[{t:'n',n:'Midge Larva'},{t:'r',n:'Slumpbuster'}]],
      'Diamond Fork':[[{t:'n',n:'Midge Larva'},{t:'r',n:'Woolly Bugger'}],[{t:'n',n:'Zebra Midge'},{t:'e',n:'Frenchie'}],[{t:'n',n:'BWO Nymph'},{t:'e',n:'RS2'},{t:'r',n:'Slumpbuster'}],[{t:'s',n:'BWO (Dry)'},{t:'n',n:'Pheasant Tail'},{t:'e',n:'Blowtorch'},{t:'r',n:'Conehead Sculpin'}],[{t:'n',n:'Caddis Larva'},{t:'e',n:'Elk Hair Caddis'},{t:'r',n:'Circus Peanut'}],[{t:'n',n:'PMD Nymph'},{t:'s',n:'Caddis (Dry)'},{t:'e',n:"Walt's Worm"},{t:'r',n:'Articulated Leech'}],[{t:'n',n:'PMD Sparkle Dun'},{t:'s',n:'Yellow Sally'},{t:'e',n:'Rainbow Warrior'},{t:'n',n:'Ant (Dry)'}],[{t:'s',n:'Hopper (Dry)'},{t:'n',n:'Trico'},{t:'e',n:'Perdigon (Olive)'},{t:'r',n:'Woolly Bugger'}],[{t:'n',n:'Mahogany Dun'},{t:'s',n:'October Caddis'},{t:'e',n:'Frenchie'},{t:'r',n:'Slumpbuster'}],[{t:'n',n:'BWO Emerger'},{t:'e',n:'Blowtorch'},{t:'r',n:'Articulated Leech'}],[{t:'n',n:'Zebra Midge'},{t:'e',n:'RS2'},{t:'r',n:'Woolly Bugger'}],[{t:'n',n:'Midge Larva'},{t:'e',n:'Frenchie'}]],
      'Sixth Water Creek':[[{t:'n',n:'Midge Larva'},{t:'r',n:'Woolly Bugger'}],[{t:'n',n:'Zebra Midge'},{t:'e',n:'Frenchie'}],[{t:'n',n:'BWO Nymph'},{t:'e',n:'RS2'},{t:'r',n:'Slumpbuster'}],[{t:'s',n:'BWO (Dry)'},{t:'n',n:'Pheasant Tail'},{t:'e',n:'Perdigon'}],[{t:'n',n:'Caddis Pupa'},{t:'e',n:'Elk Hair Caddis'},{t:'r',n:'Circus Peanut'}],[{t:'s',n:'Stimulator'},{t:'n',n:'Caddis Larva'},{t:'e',n:"Walt's Worm"}],[{t:'s',n:'PMD (Dry)'},{t:'n',n:'Yellow Sally'},{t:'e',n:'Rainbow Warrior'},{t:'s',n:'Ant (Dry)'}],[{t:'s',n:'Chubby Chernobyl'},{t:'n',n:'Trico'},{t:'e',n:'Frenchie'},{t:'s',n:'Hopper'}],[{t:'n',n:'Mahogany Dun'},{t:'s',n:'October Caddis'},{t:'e',n:'Perdigon (Olive)'}],[{t:'n',n:'BWO Emerger'},{t:'e',n:'RS2'},{t:'r',n:'Woolly Bugger'}],[{t:'n',n:'Zebra Midge'},{t:'e',n:'Frenchie'}],[{t:'n',n:'Midge Larva'},{t:'r',n:'Slumpbuster'}]],
...
function SpeciesPanel({ state, river, speciesMap, section }) {
  ...
  const speciesIds = useMemo(() => {
    ...
    if (section?.species?.length) return section.species.filter(id => ALL_SPECIES[id]);
