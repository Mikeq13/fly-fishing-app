...
function ConditionsPanel({ state, river, sectionId }) {
  ...
  return (
    <div style={{ ...S.panel(true), ...S.panelAlt }}>
      ...
      {dashboardReady && (
        <div style={{ display:'grid', gridTemplateColumns:'1fr 1fr', borderTop:'1px solid var(--border)' }}>
          ...
          <div style={{ borderTop:'1px solid var(--border)', borderRight:'1px solid var(--border)' }}>
            <SpeciesPanel state={activeState} river={activeWater} speciesMap={speciesMap} section={activeSection} />
          </div>
          ...
          <div onClick={e => e.stopPropagation()} style={{
            ...
            <div style={{ display:'flex', justifyContent:'space-between', alignItems:'flex-start', marginBottom:'1.4rem' }}>
              <div>
                ...
                <div style={{ fontFamily:"'DM Serif Display',serif", fontSize:'1.3rem', color:'var(--cream)' }}>
            ...
            {submitState === 'success' ? (
              <div style={{ textAlign:'center', padding:'2rem 0' }}>
                ...
                <div style={{ fontFamily:"'DM Serif Display',serif", fontSize:'1.2rem', color:'var(--cream)', marginBottom:'.5rem' }}>
                  Message Received!
                </div>
                ...
                <button onClick={closeModal} style={{
                  ...
                  fontFamily:"'Outfit',sans-serif", fontSize:'.77rem',
              ...
              <>
                ...
                {/* Phone + Email row */}
                <div style={{ display:'grid', gridTemplateColumns:'1fr 1fr', gap:'.75rem', marginBottom:'.95rem' }}>
                  <div>
                  ...
                  <div style={{ display:'flex', gap:'.5rem' }}>
                    {[['email','Email'],['phone','Phone Call'],['text','Text']].map(([val,lbl]) => (
                      <button key={val} onClick={() => set('preferredContact', val)} style={{
                        ...
                        fontSize:'.75rem', fontWeight:600, fontFamily:"'Outfit',sans-serif",
                      }}>{lbl}</button>
                    ))}
                  </div>
                </div>
                ...
                <button
                  ...
                  style={{
                    ...
                    fontFamily:"'Outfit',sans-serif", fontSize:'.82rem', fontWeight:700,
                    letterSpacing:'.08em', textTransform:'uppercase',
                  }}>
